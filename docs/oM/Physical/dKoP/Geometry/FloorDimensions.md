...
| Thickness | [double](https://learn.microsoft.com/en-us/dotnet/api/System.Double?view=netstandard-2.0) | Overall buildup. | [Length](/api/oM/Dimensional/Quantities/Attributes/Length) [m] |
...
{
 "$ref" : "https://raw.githubusercontent.com/BHoM/BHoM_JSONSchema/develop/dKoP_oM/FloorDimensions.json"
}
```

The JSON Schema is available on github here:

- [FloorDimensions.json](https://github.com/BHoM/BHoM_JSONSchema/blob/develop/dKoP_oM/FloorDimensions.json)
