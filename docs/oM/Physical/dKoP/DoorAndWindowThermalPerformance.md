...
# dKoP.DoorAndWindowThermalPerformance
...
???+ bhom "The DoorAndWindowThermalPerformance in inheriting from the following base type(s) and implements the following interfaces:"
