...
- [Gas.cs](https://github.com/BHoM/dKoP_Toolkit/blob/develop/dKoP_oM/Performance\Services\Gas.cs)
...
{
 "$ref" : "https://raw.githubusercontent.com/BHoM/BHoM_JSONSchema/develop/dKoP_oM/Gas.json"
}
```

The JSON Schema is available on github here:

- [Gas.json](https://github.com/BHoM/BHoM_JSONSchema/blob/develop/dKoP_oM/Gas.json)
