...
| Performance | [PartyWallPerformance](/api/oM/Physical/dKoP/Performance/PartyWallPerformance) | - | - |
...
- [PartyWall.cs](https://github.com/BHoM/dKoP_Toolkit/blob/develop/dKoP_oM/Parts\PartyWall.cs)
