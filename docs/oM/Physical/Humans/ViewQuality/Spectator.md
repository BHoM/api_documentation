...
| HeadOutline | [Polyline](/documentation/oM/Dimensional/Geometry/Polyline) | - | - |
...
|------------------|------------------|------------------|------------------|------------------|
| Cartesian | [Cartesian](/documentation/oM/Dimensional/Geometry/CoordinateSystem/Cartesian) | Find the orientation of a spectator. | - | Humans_Engine |
