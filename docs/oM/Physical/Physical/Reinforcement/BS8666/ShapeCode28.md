...
{
 "$ref" : "https://raw.githubusercontent.com/BHoM/BHoM_JSONSchema/develop/Physical_oM/Reinforcement/BS8666/ShapeCode28.json"
}
```

The JSON Schema is available on github here:

- [ShapeCode28.json](https://github.com/BHoM/BHoM_JSONSchema/blob/develop/Physical_oM/Reinforcement/BS8666/ShapeCode28.json)
