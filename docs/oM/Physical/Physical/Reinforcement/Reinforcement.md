...
{
 "$ref" : "https://raw.githubusercontent.com/BHoM/BHoM_JSONSchema/develop/Physical_oM/Reinforcement/Reinforcement.json"
}
```

The JSON Schema is available on github here:

- [Reinforcement.json](https://github.com/BHoM/BHoM_JSONSchema/blob/develop/Physical_oM/Reinforcement/Reinforcement.json)
