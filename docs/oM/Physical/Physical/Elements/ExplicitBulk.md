...
| MaterialComposition | [MaterialComposition](/documentation/oM/Physical/Physical/Materials/MaterialComposition) | Gets all the Materials a ExplicitBulk is composed of and in which ratios. | [Ratio](/documentation/oM/Dimensional/Quantities/Attributes/Ratio) [-] | Physical_Engine |
...
| SolidVolume | [double](https://learn.microsoft.com/en-us/dotnet/api/System.Double?view=netstandard-2.0) | Return the total volume of ExplicitBulk. | [Volume](/documentation/oM/Dimensional/Quantities/Attributes/Volume) [m³] | Physical_Engine |
