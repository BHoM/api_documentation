...
# Physical.Elements.ExplicitBulk
...
???+ bhom "The ExplicitBulk in inheriting from the following base type(s) and implements the following interfaces:"
...
| MaterialComposition | [MaterialComposition](/om_documentation/oM/Physical/Physical/Materials/MaterialComposition) | Gets all the Materials a ExplicitBulk is composed of and in which ratios. | [Ratio](/om_documentation/oM/Dimensional/Quantities/Attributes/Ratio) [-] | Physical_Engine |
...
| SolidVolume | [double](https://learn.microsoft.com/en-us/dotnet/api/System.Double?view=netstandard-2.0) | Return the total volume of ExplicitBulk. | [Volume](/om_documentation/oM/Dimensional/Quantities/Attributes/Volume) [m³] | Physical_Engine |
