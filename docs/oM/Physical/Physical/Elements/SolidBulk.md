...
|------------------|------------------|------------------|------------------|
| Geometry | [List](https://learn.microsoft.com/en-us/dotnet/api/System.Collections.Generic.List-1?view=netstandard-2.0)&lt;[ISolid](/api/oM/Dimensional/Geometry/ISolid)&gt; | A list of geometric solids defining the bulk geometry. | - |
