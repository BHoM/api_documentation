...
# Physical.Elements.IFramingElement
...
???+ bhom "The IFramingElement in inheriting from the following base type(s) and implements the following interfaces:"
...
|------------------|------------------|------------------|------------------|
| Location | [ICurve](/api/oM/Dimensional/Geometry/ICurve) | - | - |
