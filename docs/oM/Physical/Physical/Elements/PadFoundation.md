...
|------------------|------------------|------------------|------------------|
| Location | [PlanarSurface](/api/oM/Dimensional/Geometry/PlanarSurface) | PlanarSurface defining the top face of a pad foundation. | - |
...
| Geometry | [IGeometry](/api/oM/Dimensional/Geometry/IGeometry) | Gets the geometry of a PadFoundation as a surface. Method required for automatic display in UI packages. | - | Physical_Engine |
