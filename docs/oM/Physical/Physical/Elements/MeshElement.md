...
???+ bhom "The MeshElement in inheriting from the following base type(s) and implements the following interfaces:"
...
|------------------|------------------|------------------|------------------|
| Mesh | [Mesh](/api_documentation/oM/Dimensional/Geometry/Mesh) | Mesh defining the full 3-dimensional geometry of the element. | - |
