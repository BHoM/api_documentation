...
???+ bhom "The Pile in inheriting from the following base type(s) and implements the following interfaces:"
...
|------------------|------------------|------------------|------------------|
| Location | [ICurve](/api/oM/Dimensional/Geometry/ICurve) | Location curve of the Pile. | - |
...
|------------------|------------------|------------------|------------------|------------------|
| BottomCentreline | [ICurve](/api/oM/Dimensional/Geometry/ICurve) | Returns the bottom centreline of an IFramingElement. | - | Physical_Engine |
| BoundingBoxCentreline | [ICurve](/api/oM/Dimensional/Geometry/ICurve) | Returns the centreline of an IFramingElement's bounding box. The bounding box is aligned to the local coordinate system of the IFramingElement. | - | Physical_Engine |
...
| Geometry | [ICurve](/api/oM/Dimensional/Geometry/ICurve) | Gets the centreline geometry from the framing element. | - | Physical_Engine |
| Geometry3D | [IGeometry](/api/oM/Dimensional/Geometry/IGeometry) | Gets the 3d geometry from the framing element. | - | Physical_Engine |
...
| Normal | [Vector](/api/oM/Dimensional/Geometry/Vector) | Returns the normal of a FramingElement, which would be the Z-axis in the local coordinate syetem | - | Physical_Engine |
...
| TopCentreline | [ICurve](/api/oM/Dimensional/Geometry/ICurve) | Returns the top centreline of an IFramingElement. | - | Physical_Engine |
...
| ZJustifiedCurve | [ICurve](/api/oM/Dimensional/Geometry/ICurve) | Returns the driving curve of the given IFramingElement adjusted based on the 'z Justification' parameter value pulled from Revit.  Important: neither z offset nor any y justification is taken into account. | - | Revit_Engine |
