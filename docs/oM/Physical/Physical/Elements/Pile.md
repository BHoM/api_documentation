...
|------------------|------------------|------------------|------------------|
| Location | [ICurve](/om_documentation/oM/Dimensional/Geometry/ICurve) | Location curve of the Pile. | - |
| Property | [IFramingElementProperty](/om_documentation/oM/Physical/Physical/FramingProperties/IFramingElementProperty) | Property of the Pile defining its profile and material. | - |
...
| VolumetricMaterialTakeoff | [VolumetricMaterialTakeoff](/om_documentation/oM/Physical/Physical/Materials/VolumetricMaterialTakeoff) | Gets the volumetric material takeoff from a Pile. | - | Physical_Engine |
