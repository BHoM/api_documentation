...
{
 "$ref" : "https://raw.githubusercontent.com/BHoM/BHoM_JSONSchema/develop/Physical_oM/Elements/PileFoundation.json"
}
```

The JSON Schema is available on github here:

- [PileFoundation.json](https://github.com/BHoM/BHoM_JSONSchema/blob/develop/Physical_oM/Elements/PileFoundation.json)
