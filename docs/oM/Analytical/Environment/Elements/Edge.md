...
???+ bhom "The Edge in inheriting from the following base type(s) and implements the following interfaces:"
...
|------------------|------------------|------------------|------------------|
| Curve | [ICurve](/documentation/oM/Dimensional/Geometry/ICurve) | A BHoM Geometry planar curve object (e.g polyline, line, etc.) | - |
...
| Geometry | [ICurve](/documentation/oM/Dimensional/Geometry/ICurve) | Gets the geometry of an Edge as an ICurve | - | Environment_Engine |
...
| Polyline | [Polyline](/documentation/oM/Dimensional/Geometry/Polyline) | Returns a Polyline representation of an Environment Edge | - | Environment_Engine |
...
| ToLines | [List](https://learn.microsoft.com/en-us/dotnet/api/System.Collections.Generic.List-1?view=netstandard-2.0)&lt;[Line](/documentation/oM/Dimensional/Geometry/Line)&gt; | Returns a collection of Lines representing an Environment Edge | - | Environment_Engine |
