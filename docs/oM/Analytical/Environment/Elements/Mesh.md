...
|------------------|------------------|------------------|------------------|
| Mesh3D | [Mesh3D](/om_documentation/oM/Dimensional/Geometry/Mesh3D) | Defines the three-dimensional Mesh geometry. | - |
| BoundaryZones | [List](https://learn.microsoft.com/en-us/dotnet/api/System.Collections.Generic.List-1?view=netstandard-2.0)&lt;[BoundaryZone](/om_documentation/oM/Analytical/Environment/Elements/BoundaryZone)&gt; | Defines the partition of the meshes external faces. | - |
