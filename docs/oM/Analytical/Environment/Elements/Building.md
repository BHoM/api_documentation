...
|------------------|------------------|------------------|------------------|
| Location | [Location](/api_documentation/oM/Analytical/Environment/Climate/Location) | The real-world Earth location for the building | - |
| Elevation | [double](https://learn.microsoft.com/en-us/dotnet/api/System.Double?view=netstandard-2.0) | The elevation for the location above sea level | [Length](/api_documentation/oM/Dimensional/Quantities/Attributes/Length) [m] |
| Type | [BuildingType](/api_documentation/oM/Analytical/Environment/Elements/BuildingType) | The main classification for the building (e.g. Office, Residential). Use BuildingType enum) | - |
