...
???+ bhom "The Panel in inheriting from the following base type(s) and implements the following interfaces:"
    ...
    -  Analytical.Elements.[IPanel](/api_documentation/oM/Analytical/Analytical/Elements/IPanel%602)&lt;Environment.Elements.[Edge](/api_documentation/oM/Analytical/Environment/Elements/Edge), Environment.Elements.[Opening](/api_documentation/oM/Analytical/Environment/Elements/Opening)&gt;
...
|------------------|------------------|------------------|------------------|
| ExternalEdges | [List](https://learn.microsoft.com/en-us/dotnet/api/System.Collections.Generic.List-1?view=netstandard-2.0)&lt;[Edge](/api_documentation/oM/Analytical/Environment/Elements/Edge)&gt; | A collection of Environment Edge objects which defines the external boundary of the panel | - |
| Openings | [List](https://learn.microsoft.com/en-us/dotnet/api/System.Collections.Generic.List-1?view=netstandard-2.0)&lt;[Opening](/api_documentation/oM/Analytical/Environment/Elements/Opening)&gt; | A collection of cutouts or holes in a building surface/panel (e.g. Window, Door, Rooflight) | - |
| Construction | [IConstruction](/api_documentation/oM/Physical/Physical/Constructions/IConstruction) | A construction object providing layer and material information for the panel | - |
| Type | [PanelType](/api_documentation/oM/Analytical/Environment/Elements/PanelType) | The type of environmental surface (e.g. Wall, Floor, Roof). Use PanelType enum) | - |
...
| Bounds | [BoundingBox](/api_documentation/oM/Dimensional/Geometry/BoundingBox) | Returns the bounding box of an Environment Panel | - | Environment_Engine |
...
| InternalElements2D | [List](https://learn.microsoft.com/en-us/dotnet/api/System.Collections.Generic.List-1?view=netstandard-2.0)&lt;[IElement2D](/api_documentation/oM/Dimensional/Dimensional/IElement2D)&gt; | Returns the internal 2D elements of an Environment Panel | - | Environment_Engine |
...
| MaterialComposition | [MaterialComposition](/api_documentation/oM/Physical/Physical/Materials/MaterialComposition) | Gets all the Materials a Panel is composed of and in which ratios | - | Environment_Engine |
...
| NewInternalElement2D | [IElement2D](/api_documentation/oM/Dimensional/Dimensional/IElement2D) | Returns an instance of an IElement2D from the given object | - | Environment_Engine |
...
| OutlineElements1D | [List](https://learn.microsoft.com/en-us/dotnet/api/System.Collections.Generic.List-1?view=netstandard-2.0)&lt;[IElement1D](/api_documentation/oM/Dimensional/Dimensional/IElement1D)&gt; | Returns the outline 1D elements of an Environment Panel | - | Environment_Engine |
| Polyline | [Polyline](/api_documentation/oM/Dimensional/Geometry/Polyline) | Returns the external boundary from an Environment Panel as a BHoM Geometry Polyline | - | Environment_Engine |
...
| SolidVolume | [double](https://learn.microsoft.com/en-us/dotnet/api/System.Double?view=netstandard-2.0) | Returns an Openings solid volume based on its area, and construction thickness | [Volume](/api_documentation/oM/Dimensional/Quantities/Attributes/Volume) [m³] | Environment_Engine |
...
| ToLines | [List](https://learn.microsoft.com/en-us/dotnet/api/System.Collections.Generic.List-1?view=netstandard-2.0)&lt;[Line](/api_documentation/oM/Dimensional/Geometry/Line)&gt; | Returns the external boundary from an Environment Panel as a collection of BHoM Geometry Lines | - | Environment_Engine |
...
| Vertices | [List](https://learn.microsoft.com/en-us/dotnet/api/System.Collections.Generic.List-1?view=netstandard-2.0)&lt;[Point](/api_documentation/oM/Dimensional/Geometry/Point)&gt; | Returns a collection of vertices for an Environment Panel | - | Environment_Engine |
