...
| SpaceType | [SpaceType](/api/oM/Analytical/Environment/Elements/SpaceType) | Space Type is an enum that defines how the space is used (Museum, Corridor, etc) | - |
| Location | [Point](/api/oM/Dimensional/Geometry/Point) | A point in 3D space providing a location point of the space | - |
| Perimeter | [ICurve](/api/oM/Dimensional/Geometry/ICurve) | A 2D curve defining the external boundaries of the floor of the space | - |
...
| Polyline | [Polyline](/api/oM/Dimensional/Geometry/Polyline) | Returns the external boundary from an Environment Space as a BHoM Geometry Polyline | - | Environment_Engine |
