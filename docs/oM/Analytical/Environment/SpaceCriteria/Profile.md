...
|------------------|------------------|------------------|------------------|
| ProfileType | [ProfileType](/documentation/oM/Analytical/Environment/SpaceCriteria/ProfileType) | Profile Type depicts the type of profile (OnOff (0 or 1), ModulatingPercentage (0.0-1.0), or Absolute (-10000 to +10000)) | - |
| ProfileDay | [List](https://learn.microsoft.com/en-us/dotnet/api/System.Collections.Generic.List-1?view=netstandard-2.0)&lt;[ProfileDay](/documentation/oM/Analytical/Environment/SpaceCriteria/ProfileDay)&gt; | Profile Day depicts the day described in the profile, whether it's a day of the week or a holiday | - |
