...
# Environment.Results.WindSpeedResult
...
???+ bhom "The WindSpeedResult in inheriting from the following base type(s) and implements the following interfaces:"
...
|------------------|------------------|------------------|------------------|
| Result | [double](https://learn.microsoft.com/en-us/dotnet/api/System.Double?view=netstandard-2.0) | The value associated with the results object. | [Velocity](/api_documentation/oM/Dimensional/Quantities/Attributes/Velocity) [m/s] |
