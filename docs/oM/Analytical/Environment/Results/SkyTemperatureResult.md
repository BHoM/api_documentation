...
# Environment.Results.SkyTemperatureResult
...
???+ bhom "The SkyTemperatureResult in inheriting from the following base type(s) and implements the following interfaces:"
