...
|------------------|------------------|------------------|------------------|
| Unit | [ProfileResultUnit](/documentation/oM/Analytical/Environment/Results/ProfileResultUnit) | The unit measurement of the profile result from the Profile Result enum | - |
| Type | [ProfileResultType](/documentation/oM/Analytical/Environment/Results/ProfileResultType) | The type of the profile result from the Profile Result enum | - |
