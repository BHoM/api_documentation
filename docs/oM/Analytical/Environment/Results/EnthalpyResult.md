...
# Environment.Results.EnthalpyResult
...
???+ bhom "The EnthalpyResult in inheriting from the following base type(s) and implements the following interfaces:"
...
|------------------|------------------|------------------|------------------|
| Result | [double](https://learn.microsoft.com/en-us/dotnet/api/System.Double?view=netstandard-2.0) | The value associated with the results object. | [SpecificEnergy](/api_documentation/oM/Dimensional/Quantities/Attributes/SpecificEnergy) [H] |
