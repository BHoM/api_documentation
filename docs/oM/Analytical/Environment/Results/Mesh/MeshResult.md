...
{
 "$ref" : "https://raw.githubusercontent.com/BHoM/BHoM_JSONSchema/develop/Environment_oM/Results/Mesh/MeshResult.json"
}
```

The JSON Schema is available on github here:

- [MeshResult.json](https://github.com/BHoM/BHoM_JSONSchema/blob/develop/Environment_oM/Results/Mesh/MeshResult.json)
