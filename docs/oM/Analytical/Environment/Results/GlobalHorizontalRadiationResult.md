...
# Environment.Results.GlobalHorizontalRadiationResult
...
???+ bhom "The GlobalHorizontalRadiationResult in inheriting from the following base type(s) and implements the following interfaces:"
