...
| Results | [List](https://learn.microsoft.com/en-us/dotnet/api/System.Collections.Generic.List-1?view=netstandard-2.0)&lt;[TimeIndexResult](/documentation/oM/Analytical/Environment/Results/TimeIndexResult)&gt; | A list of TimeIndexResults for nodes with time dependent results. | - |
...
| Geometry | [Point](/documentation/oM/Dimensional/Geometry/Point) | Gets the geometry of a Node as a Point. Method required for automatic display in UI packages | - | Environment_Engine |
