...
{
 "$ref" : "https://raw.githubusercontent.com/BHoM/BHoM_JSONSchema/develop/Environment_oM/Configuration/OpeningOption.json"
}
```

The JSON Schema is available on github here:

- [OpeningOption.json](https://github.com/BHoM/BHoM_JSONSchema/blob/develop/Environment_oM/Configuration/OpeningOption.json)
