...
# Environment.Fragments.BuildingResultFragment
...
???+ bhom "The BuildingResultFragment in inheriting from the following base type(s) and implements the following interfaces:"
