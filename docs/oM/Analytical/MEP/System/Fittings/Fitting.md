...
|------------------|------------------|------------------|------------------|
| Location | [Point](/om_documentation/oM/Dimensional/Geometry/Point) | The point at which the Fitting occurs. | - |
| ConnectionsLocation | [List](https://learn.microsoft.com/en-us/dotnet/api/System.Collections.Generic.List-1?view=netstandard-2.0)&lt;[Point](/om_documentation/oM/Dimensional/Geometry/Point)&gt; | The points at which the Fitting physically connects to other MEP segments. | - |
| Type | [FittingType](/om_documentation/oM/Analytical/MEP/Enums/FittingType) | The type of fitting connected to an element. | - |
...
| Geometry | [List](https://learn.microsoft.com/en-us/dotnet/api/System.Collections.Generic.List-1?view=netstandard-2.0)&lt;[Line](/om_documentation/oM/Dimensional/Geometry/Line)&gt; | Queries a Fitting object for its geometry. | - | MEP_Engine |
