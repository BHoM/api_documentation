...
| ValveType | [ValveType](/documentation/oM/Analytical/MEP/Enums/ValveType) | A type which describes the valve, more specifically whether it's a check valve, gate valve, etc. | - |
