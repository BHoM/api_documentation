...
???+ bhom "The Valve in inheriting from the following base type(s) and implements the following interfaces:"
...
| ValveType | [ValveType](/api_documentation/oM/Analytical/MEP/Enums/ValveType) | A type which describes the valve, more specifically whether it's a check valve, gate valve, etc. | - |
