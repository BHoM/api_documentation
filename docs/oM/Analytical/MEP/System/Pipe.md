...
|------------------|------------------|------------------|------------------|
| StartPoint | [Point](/api_documentation/oM/Dimensional/Geometry/Point) | The point at which the Pipe object begins. | - |
| EndPoint | [Point](/api_documentation/oM/Dimensional/Geometry/Point) | The point at which the Pipe object ends. | - |
...
| SectionProperty | [PipeSectionProperty](/api_documentation/oM/Analytical/MEP/System/SectionProperties/PipeSectionProperty) | The pipe section property defines the shape and its associated properties (radius, material, thickness). | - |
...
| MaterialComposition | [MaterialComposition](/api_documentation/oM/Physical/Physical/Materials/MaterialComposition) | Gets all the Materials a pipe is composed of and in which ratios | [Ratio](/api_documentation/oM/Dimensional/Quantities/Attributes/Ratio) [-] | MEP_Engine |
