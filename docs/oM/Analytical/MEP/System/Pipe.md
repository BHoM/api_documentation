...
|------------------|------------------|------------------|------------------|
| StartPoint | [Point](/api/oM/Dimensional/Geometry/Point) | The point at which the Pipe object begins. | - |
| EndPoint | [Point](/api/oM/Dimensional/Geometry/Point) | The point at which the Pipe object ends. | - |
