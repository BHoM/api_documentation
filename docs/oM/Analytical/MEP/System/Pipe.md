...
|------------------|------------------|------------------|------------------|
| StartPoint | [Point](/om_documentation/oM/Dimensional/Geometry/Point) | The point at which the Pipe object begins. | - |
| EndPoint | [Point](/om_documentation/oM/Dimensional/Geometry/Point) | The point at which the Pipe object ends. | - |
...
| SectionProperty | [PipeSectionProperty](/om_documentation/oM/Analytical/MEP/System/SectionProperties/PipeSectionProperty) | The pipe section property defines the shape and its associated properties (radius, material, thickness). | - |
...
| MaterialComposition | [MaterialComposition](/om_documentation/oM/Physical/Physical/Materials/MaterialComposition) | Gets all the Materials a pipe is composed of and in which ratios | [Ratio](/om_documentation/oM/Dimensional/Quantities/Attributes/Ratio) [-] | MEP_Engine |
