...
|------------------|------------------|------------------|------------------|
| StartPoint | [Point](/documentation/oM/Dimensional/Geometry/Point) | The point at which the Pipe object begins. | - |
| EndPoint | [Point](/documentation/oM/Dimensional/Geometry/Point) | The point at which the Pipe object ends. | - |
...
| SectionProperty | [PipeSectionProperty](/documentation/oM/Analytical/MEP/System/SectionProperties/PipeSectionProperty) | The pipe section property defines the shape and its associated properties (radius, material, thickness). | - |
...
| MaterialComposition | [MaterialComposition](/documentation/oM/Physical/Physical/Materials/MaterialComposition) | Gets all the Materials a pipe is composed of and in which ratios | [Ratio](/documentation/oM/Dimensional/Quantities/Attributes/Ratio) [-] | MEP_Engine |
