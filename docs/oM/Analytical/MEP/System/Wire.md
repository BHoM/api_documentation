...
???+ bhom "The Wire in inheriting from the following base type(s) and implements the following interfaces:"
...
|------------------|------------------|------------------|------------------|
| WireSegments | [List](https://learn.microsoft.com/en-us/dotnet/api/System.Collections.Generic.List-1?view=netstandard-2.0)&lt;[WireSegment](/api_documentation/oM/Analytical/MEP/System/WireSegment)&gt; | Collection of WireSegments. | - |
