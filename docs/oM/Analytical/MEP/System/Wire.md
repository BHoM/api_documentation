...
|------------------|------------------|------------------|------------------|
| WireSegments | [List](https://learn.microsoft.com/en-us/dotnet/api/System.Collections.Generic.List-1?view=netstandard-2.0)&lt;[WireSegment](/om_documentation/oM/Analytical/MEP/System/WireSegment)&gt; | Collection of WireSegments. | - |
