...
|------------------|------------------|------------------|------------------|
| FlowObjects | [List](https://learn.microsoft.com/en-us/dotnet/api/System.Collections.Generic.List-1?view=netstandard-2.0)&lt;[IFlow](/documentation/oM/Analytical/MEP/System/IFlow)&gt; | A collection of FlowObjects to compile within a specified systemType. | - |
| SystemType | [ISystemType](/documentation/oM/Analytical/MEP/System/ISystemType) | A specific system type to be applied to the flow objects. The system type describes the material conveyed by the system (supply air, cold water), therefore determining the behaviours of the system | - |
