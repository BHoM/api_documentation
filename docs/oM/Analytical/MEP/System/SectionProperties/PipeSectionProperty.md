...
|------------------|------------------|------------------|------------------|
| PipeMaterial | [Material](/om_documentation/oM/Physical/Physical/Materials/Material) | The pipe material is the primary material that the pipe is composed of (copper, black steel, PEX) | - |
| InsulationMaterial | [Material](/om_documentation/oM/Physical/Physical/Materials/Material) | The insulation is the layer of material outside of the pipe material, meant to insulate the internal conditions of the material being conveyed. | - |
