...
|------------------|------------------|------------------|------------------|
| ConductiveMaterial | [Material](/api_documentation/oM/Physical/Physical/Materials/Material) | The wire material is the primary material that the wire is composed of (copper, aluminium). | - |
| InsulationMaterial | [Material](/api_documentation/oM/Physical/Physical/Materials/Material) | The insulation is the layer of material outside of the conductive material, meant to insulate the internal conditions of the conductive material. | - |
