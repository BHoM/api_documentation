...
|------------------|------------------|------------------|------------------|
| StartPoint | [Point](/api_documentation/oM/Dimensional/Geometry/Point) | The point at which the Flow Object begins. | - |
| EndPoint | [Point](/api_documentation/oM/Dimensional/Geometry/Point) | The point at which the Flow Object ends. | - |
