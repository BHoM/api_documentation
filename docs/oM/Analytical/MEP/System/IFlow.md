...
|------------------|------------------|------------------|------------------|
| StartPoint | [Point](/om_documentation/oM/Dimensional/Geometry/Point) | The point at which the Flow Object begins. | - |
| EndPoint | [Point](/om_documentation/oM/Dimensional/Geometry/Point) | The point at which the Flow Object ends. | - |
