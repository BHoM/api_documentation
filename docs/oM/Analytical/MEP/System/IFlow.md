...
???+ bhom "The IFlow in inheriting from the following base type(s) and implements the following interfaces:"
...
|------------------|------------------|------------------|------------------|
| StartPoint | [Point](/api/oM/Dimensional/Geometry/Point) | The point at which the Flow Object begins. | - |
| EndPoint | [Point](/api/oM/Dimensional/Geometry/Point) | The point at which the Flow Object ends. | - |
