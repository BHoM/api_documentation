...
# MEP.System.MaterialFragments.CableTrayMaterial
...
???+ bhom "The CableTrayMaterial in inheriting from the following base type(s) and implements the following interfaces:"
