...
???+ bhom "The WireSegment in inheriting from the following base type(s) and implements the following interfaces:"
...
|------------------|------------------|------------------|------------------|
| StartPoint | [Point](/api/oM/Dimensional/Geometry/Point) | The point at which the Wire object begins. | - |
| EndPoint | [Point](/api/oM/Dimensional/Geometry/Point) | The point at which the Wire object ends. | - |
...
| Centreline | [Line](/api/oM/Dimensional/Geometry/Line) | Returns the centreline of any IFlow object as the line between the StartPoint and EndPoint. No offsets or similar is accounted for. | - | MEP_Engine |
...
| Geometry | [IGeometry](/api/oM/Dimensional/Geometry/IGeometry) | Queries an IFlow object for its geometry. | - | MEP_Engine |
