...
# MEP.Equipment.ElectricalEquipment
...
???+ bhom "The ElectricalEquipment in inheriting from the following base type(s) and implements the following interfaces:"
...
| ElectricalEquipmentType | [ElectricalEquipmentType](/api_documentation/oM/Analytical/MEP/Enums/ElectricalEquipmentType) | A type which describes the electrical equipment, more specifically whether it's switchgear, panelboard, transformer, etc. | - |
| Parts | [List](https://learn.microsoft.com/en-us/dotnet/api/System.Collections.Generic.List-1?view=netstandard-2.0)&lt;[IPart](/api_documentation/oM/Analytical/MEP/Equipment/Parts/IPart)&gt; | A collection of the parts (Electrical Connector) that make up the Electrical Equipment | - |
