...
???+ bhom "The FireAlarmDevice in inheriting from the following base type(s) and implements the following interfaces:"
...
| FireAlarmDeviceType | [FireAlarmDeviceType](/api_documentation/oM/Analytical/MEP/Enums/FireAlarmDeviceType) | A type which describes the fire alarm device more specifically whether it's a smoke detector, carbon monoxide detector or speaker strobe. | - |
