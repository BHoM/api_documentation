...
| BaseProperty | [ISurfaceProperty](/api_documentation/oM/Analytical/Structure/SurfaceProperties/ISurfaceProperty) | Base property which is being topped. | - |
| ToppingThickness | [double](https://learn.microsoft.com/en-us/dotnet/api/System.Double?view=netstandard-2.0) | Thickness of the topping added on top of the base surface property. | [Length](/api_documentation/oM/Dimensional/Quantities/Attributes/Length) [m] |
| Material | [IMaterialFragment](/api_documentation/oM/Analytical/Structure/MaterialFragments/IMaterialFragment) | Material for the topping of the slab. | - |
