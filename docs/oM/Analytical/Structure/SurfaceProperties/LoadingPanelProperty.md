...
| LoadApplication | [LoadPanelSupportConditions](/om_documentation/oM/Analytical/Structure/SurfaceProperties/LoadPanelSupportConditions) | Load application enum defining to which edges the load should be distributed. | - |
...
| Material | [IMaterialFragment](/om_documentation/oM/Analytical/Structure/MaterialFragments/IMaterialFragment) | Material of the property, redundant for most structural applications. | - |
...
| MassPerArea | [double](https://learn.microsoft.com/en-us/dotnet/api/System.Double?view=netstandard-2.0) | Gets the mass per area for a LoadingPanelProperty. This will always return 0. | [MassPerUnitArea](/om_documentation/oM/Dimensional/Quantities/Attributes/MassPerUnitArea) [kg/m²] | Structure_Engine |
