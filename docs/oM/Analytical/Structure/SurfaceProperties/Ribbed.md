...
| TotalDepth | [double](https://learn.microsoft.com/en-us/dotnet/api/System.Double?view=netstandard-2.0) | Total depth measured from the bottom of the ribs to the top of the slab. | [Length](/om_documentation/oM/Dimensional/Quantities/Attributes/Length) [m] |
