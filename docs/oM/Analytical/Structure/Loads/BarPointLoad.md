...
{
 "$ref" : "https://raw.githubusercontent.com/BHoM/BHoM_JSONSchema/develop/Structure_oM/Loads/BarPointLoad.json"
}
```

The JSON Schema is available on github here:

- [BarPointLoad.json](https://github.com/BHoM/BHoM_JSONSchema/blob/develop/Structure_oM/Loads/BarPointLoad.json)
