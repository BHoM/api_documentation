...
|------------------|------------------|------------------|------------------|
| UniformLoadSet | [UniformLoadSet](/om_documentation/oM/Analytical/Structure/Loads/UniformLoadSet) | A UniformLoadSet containing a list of uniform loads to be applied in the gravity direction | - |
