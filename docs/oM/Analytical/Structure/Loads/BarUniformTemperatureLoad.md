...
|------------------|------------------|------------------|------------------|
| TemperatureChange | [double](https://learn.microsoft.com/en-us/dotnet/api/System.Double?view=netstandard-2.0) | Uniform temperature change of the Bar. | [Temperature](/documentation/oM/Dimensional/Quantities/Attributes/Temperature) [K] |
