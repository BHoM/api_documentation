...
# <small>BH.oM.Structure.</small>**BarDifferentialTemperatureLoad**
...
| LoadDirection | [DifferentialTemperatureLoadDirection](/api/oM/Analytical/Structure/Loads/Enums/LocalLoadDirection) | The direction of the temperature variation, relative to the local axis of the profile. | - |
