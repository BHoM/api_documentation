...
# Structure.Loads.BarDifferentialTemperatureLoad
...
| LoadDirection | [DifferentialTemperatureLoadDirection](/api/oM/Analytical/Structure/Loads/DifferentialTemperatureLoadDirection) | The direction of the temperature variation, relative to the local axis of the profile. | - |
