...
{
 "$ref" : https://raw.githubusercontent.com/BHoM/BHoM_JSONSchema/develop/Structure_oM/Results/SteelUtilisation.json}
```

The JSON Schema is available on github here:

- [SteelUtilisation.json](https://github.com/BHoM/BHoM_JSONSchema/blob/develop/Structure_oM/Results/SteelUtilisation.json)
