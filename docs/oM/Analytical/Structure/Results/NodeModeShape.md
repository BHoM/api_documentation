...
| RZ | [double](https://learn.microsoft.com/en-us/dotnet/api/System.Double?view=netstandard-2.0) | Rotational component about the Z-axis of the mode shape in global coordinates. | [Angle](/documentation/oM/Dimensional/Quantities/Attributes/Angle) [rad] |
