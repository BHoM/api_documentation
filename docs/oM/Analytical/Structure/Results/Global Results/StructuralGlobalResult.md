...
{
 "$ref" : "https://raw.githubusercontent.com/BHoM/BHoM_JSONSchema/develop/Structure_oM/Results/StructuralGlobalResult.json"
}
```

The JSON Schema is available on github here:

- [StructuralGlobalResult.json](https://github.com/BHoM/BHoM_JSONSchema/blob/develop/Structure_oM/Results/StructuralGlobalResult.json)
