...
| MTotal | [double](https://learn.microsoft.com/en-us/dotnet/api/System.Double?view=netstandard-2.0) | Gets the resolved bending moment of the major and minor components of the result. | [Moment](/api_documentation/oM/Dimensional/Quantities/Attributes/Moment) [N.m] | Structure_Engine |
