...
| NormalisationProcedure | [ModalResultNormalisation](/api/oM/Analytical/Structure/Results/ModalResultNormalisation) | States if the result has been normalised based on the Eigenvector or on the Mass. | - |
