...
|------------------|------------------|------------------|------------------|
| UX | [double](https://learn.microsoft.com/en-us/dotnet/api/System.Double?view=netstandard-2.0) | Local deformation of the Bar along the local x-axis. Local axial deformation of the Bar. | [Length](/om_documentation/oM/Dimensional/Quantities/Attributes/Length) [m] |
| UY | [double](https://learn.microsoft.com/en-us/dotnet/api/System.Double?view=netstandard-2.0) | Local deformation of the Bar along the local y-axis. Generally minor axis deformation. | [Length](/om_documentation/oM/Dimensional/Quantities/Attributes/Length) [m] |
| UZ | [double](https://learn.microsoft.com/en-us/dotnet/api/System.Double?view=netstandard-2.0) | Local deformation of the Bar along the local z-axis. Generally major axis deformation. | [Length](/om_documentation/oM/Dimensional/Quantities/Attributes/Length) [m] |
| RX | [double](https://learn.microsoft.com/en-us/dotnet/api/System.Double?view=netstandard-2.0) | Localised rotation of the Bar about the local x-axis. Twist of the Bar. | [Angle](/om_documentation/oM/Dimensional/Quantities/Attributes/Angle) [rad] |
| RY | [double](https://learn.microsoft.com/en-us/dotnet/api/System.Double?view=netstandard-2.0) | Localised rotation of the Bar about the local y-axis. Generally major axis rotation. | [Angle](/om_documentation/oM/Dimensional/Quantities/Attributes/Angle) [rad] |
| RZ | [double](https://learn.microsoft.com/en-us/dotnet/api/System.Double?view=netstandard-2.0) | Localised rotation of the Bar about the local z-axis. Generally minor axis rotation. | [Angle](/om_documentation/oM/Dimensional/Quantities/Attributes/Angle) [rad] |
