...
{
 "$ref" : "https://raw.githubusercontent.com/BHoM/BHoM_JSONSchema/develop/Structure_oM/Design/DesignGroup.json"
}
```

The JSON Schema is available on github here:

- [DesignGroup.json](https://github.com/BHoM/BHoM_JSONSchema/blob/develop/Structure_oM/Design/DesignGroup.json)
