...
|------------------|------------------|------------------|------------------|
| TopNode | [Node](/om_documentation/oM/Analytical/Structure/Elements/Node) | Defines the top Node. Note that Nodes can contain Supports. | - |
| BottomNode | [Node](/om_documentation/oM/Analytical/Structure/Elements/Node) | Defines the end position of the Pile. Note that Nodes can contain Supports. | - |
| Section | [ISectionProperty](/om_documentation/oM/Analytical/Structure/SectionProperties/ISectionProperty) | Section property of the Pile, containing all sectional constants and material as well as profile geometry and dimensions, where applicable. | - |
...
| Elements0D | [List](https://learn.microsoft.com/en-us/dotnet/api/System.Collections.Generic.List-1?view=netstandard-2.0)&lt;[IElement0D](/om_documentation/oM/Dimensional/Dimensional/IElement0D)&gt; | Gets the Element0Ds of a Pile, which for the case of a Pile means getting the StartNode and EndNode. Method necessary for IElement pattern. | - | Structure_Engine |
...
| Geometry | [IGeometry](/om_documentation/oM/Dimensional/Geometry/IGeometry) | Gets the geometry of a Pile as a single line. Method required for automatic display in UI packages. | - | Structure_Engine |
| Geometry3D | [IGeometry](/om_documentation/oM/Dimensional/Geometry/IGeometry) | Gets the BH.oM.Geometry.Extrusion out of the Pile as its Geometry3D. | - | Structure_Engine |
...
| MaterialComposition | [MaterialComposition](/om_documentation/oM/Physical/Physical/Materials/MaterialComposition) | Returns a Pile's homogeneous MaterialComposition. | - | Structure_Engine |
...
| SolidVolume | [double](https://learn.microsoft.com/en-us/dotnet/api/System.Double?view=netstandard-2.0) | Returns a Pile's solid volume based on its Section area and the CentreLine length. | [Volume](/om_documentation/oM/Dimensional/Quantities/Attributes/Volume) [m³] | Structure_Engine |
