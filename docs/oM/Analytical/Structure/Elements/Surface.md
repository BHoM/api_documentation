...
|------------------|------------------|------------------|------------------|
| Extents | [ISurface](/api_documentation/oM/Dimensional/Geometry/ISurface) | A geometrical surface defining the 'centre plane` of the surface. | - |
| Property | [ISurfaceProperty](/api_documentation/oM/Analytical/Structure/SurfaceProperties/ISurfaceProperty) | Defines the thickness property and material of the Element. | - |
| PlanarSpring | [Constraint3DOF](/api_documentation/oM/Analytical/Structure/Constraints/Constraint3DOF) | A planar support for the Surface, constraining the movement in the translational degrees of freedom. | - |
...
|------------------|------------------|------------------|------------------|------------------|
| Area | [double](https://learn.microsoft.com/en-us/dotnet/api/System.Double?view=netstandard-2.0) | Calculates the area of a Surface based on the area of the geometrical surface stored in Extents. | [Area](/api_documentation/oM/Dimensional/Quantities/Attributes/Area) [m²] | Structure_Engine |
| Edges | [List](https://learn.microsoft.com/en-us/dotnet/api/System.Collections.Generic.List-1?view=netstandard-2.0)&lt;[ICurve](/api_documentation/oM/Dimensional/Geometry/ICurve)&gt; | Extracts the edge curves from the geometric surface of the element. | - | Structure_Engine |
