...
|------------------|------------------|------------------|------------------|
| Extents | [ISurface](/api/oM/Dimensional/Geometry/ISurface) | A geometrical surface defining the 'centre plane` of the surface. | - |
...
| Edges | [List](https://learn.microsoft.com/en-us/dotnet/api/System.Collections.Generic.List-1?view=netstandard-2.0)&lt;[ICurve](/api/oM/Dimensional/Geometry/ICurve)&gt; | Extracts the edge curves from the geometric surface of the element. | - | Structure_Engine |
