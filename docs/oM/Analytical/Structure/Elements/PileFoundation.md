...
| Geometry | [IGeometry](/api/oM/Dimensional/Geometry/IGeometry) | Gets the geometry of a PileFoundation. Method required for automatic display in UI packages. | - | Structure_Engine |
| Geometry3D | [IGeometry](/api/oM/Dimensional/Geometry/IGeometry) | Gets a CompositeGeometry made of the PileCap and Piles of a PileFoundation. | - | Structure_Engine |
