...
???+ bhom "The Opening in inheriting from the following base type(s) and implements the following interfaces:"
    ...
    -  Analytical.Elements.[IOpening](/documentation/oM/Analytical/Analytical/Elements/IOpening%601)&lt;Structure.Elements.[Edge](/documentation/oM/Analytical/Structure/Elements/Edge)&gt;
...
|------------------|------------------|------------------|------------------|
| Edges | [List](https://learn.microsoft.com/en-us/dotnet/api/System.Collections.Generic.List-1?view=netstandard-2.0)&lt;[Edge](/documentation/oM/Analytical/Structure/Elements/Edge)&gt; | A list of coplanar Edges defining the contour and potential constraints of the Opening. | - |
