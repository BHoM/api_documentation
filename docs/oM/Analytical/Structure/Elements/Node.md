...
| Orientation | [Basis](/api/oM/Dimensional/Geometry/Basis) | Local x, y, and z axes of the node as a vector Basis. Defaults to null which is interpretated to defaults when pushed to software and world axes in BHoM. | - |
