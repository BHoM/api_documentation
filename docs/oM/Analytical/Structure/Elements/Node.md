...
|------------------|------------------|------------------|------------------|
| Position | [Point](/api_documentation/oM/Dimensional/Geometry/Point) | Position of the node in global Cartesian 3D space. | - |
| Orientation | [Basis](/api_documentation/oM/Dimensional/Geometry/Basis) | Local x, y, and z axes of the node as a vector Basis. Defaults to null which is interpretated to defaults when pushed to software and world axes in BHoM. | - |
| Support | [Constraint6DOF](/api_documentation/oM/Analytical/Structure/Constraints/Constraint6DOF) | Defines the Support property of the Node. If not set, the Node will be assumed to be free to translate and rotate. | - |
...
| CoordinateSystem | [Cartesian](/api_documentation/oM/Dimensional/Geometry/CoordinateSystem/Cartesian) | Get the carteseian coordinate system descibring the position and local orientation of the node in the global coordinate system. | - | Structure_Engine |
...
| Geometry | [Point](/api_documentation/oM/Dimensional/Geometry/Point) | Gets the geometry of a INode as a Point. Method required for automatic display in UI packages. | - | Analytical_Engine |
