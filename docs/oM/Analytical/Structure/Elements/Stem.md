...
???+ bhom "The Stem in inheriting from the following base type(s) and implements the following interfaces:"
...
|------------------|------------------|------------------|------------------|
| Perimeter | [ICurve](/om_documentation/oM/Dimensional/Geometry/ICurve) | Planar curve defining the edges at center of the Stem. | - |
...
| Normal | [Vector](/om_documentation/oM/Dimensional/Geometry/Vector) | Normal to the surface of the Stem denoting the direction of the retained face. | - |
...
| Geometry3D | [IGeometry](/om_documentation/oM/Dimensional/Geometry/IGeometry) | Gets a CompositeGeometry made of boundary surfaces of the Stem based on its outline, thicknesses and orientation. | - | Structure_Engine |
...
| MaterialComposition | [MaterialComposition](/om_documentation/oM/Physical/Physical/Materials/MaterialComposition) | Returns a Stem's homogeneous MaterialComposition. | - | Structure_Engine |
...
| SolidVolume | [double](https://learn.microsoft.com/en-us/dotnet/api/System.Double?view=netstandard-2.0) | Returns a Stem's solid volume based on the area of the element and its top and bottom thickness. | [Volume](/om_documentation/oM/Dimensional/Quantities/Attributes/Volume) [m³] | Structure_Engine |
