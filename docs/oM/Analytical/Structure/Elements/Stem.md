...
|------------------|------------------|------------------|------------------|
| Perimeter | [ICurve](/api/oM/Dimensional/Geometry/ICurve) | Planar curve defining the edges at center of the Stem. | - |
...
| Normal | [Vector](/api/oM/Dimensional/Geometry/Vector) | Normal to the surface of the Stem denoting the direction of the retained face. | - |
...
| Geometry3D | [IGeometry](/api/oM/Dimensional/Geometry/IGeometry) | Gets a CompositeGeometry made of boundary surfaces of the Stem based on its outline, thicknesses and orientation. | - | Structure_Engine |
