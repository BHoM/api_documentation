...
???+ bhom "The Milestone in inheriting from the following base type(s) and implements the following interfaces:"
...
| State | [ItemState](/om_documentation/oM/Analytical/Planning/ItemState) | - | - |
