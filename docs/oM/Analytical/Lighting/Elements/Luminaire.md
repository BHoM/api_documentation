...
|------------------|------------------|------------------|------------------|
| Position | [Point](/om_documentation/oM/Dimensional/Geometry/Point) | Position of the Luminaire in global Cartesian 3D space. | - |
...
| Orientation | [Basis](/om_documentation/oM/Dimensional/Geometry/Basis) | The direction that the Luminaire is oriented towards. | - |
| LuminaireType | [LuminaireType](/om_documentation/oM/Analytical/Lighting/Elements/LuminaireType) | The Luminaire Type applied to the Luminaire. | - |
...
| Geometry | [Point](/om_documentation/oM/Dimensional/Geometry/Point) | Gets the geometry of a Luminaire as a Point. | - | Lighting_Engine |
