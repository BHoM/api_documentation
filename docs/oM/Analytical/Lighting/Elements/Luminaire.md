...
|------------------|------------------|------------------|------------------|
| Position | [Point](/documentation/oM/Dimensional/Geometry/Point) | Position of the Luminaire in global Cartesian 3D space. | - |
...
| Orientation | [Basis](/documentation/oM/Dimensional/Geometry/Basis) | The direction that the Luminaire is oriented towards. | - |
| LuminaireType | [LuminaireType](/documentation/oM/Analytical/Lighting/Elements/LuminaireType) | The Luminaire Type applied to the Luminaire. | - |
...
| Geometry | [Point](/documentation/oM/Dimensional/Geometry/Point) | Gets the geometry of a Luminaire as a Point. | - | Lighting_Engine |
