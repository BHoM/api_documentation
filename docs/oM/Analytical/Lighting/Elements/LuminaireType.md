...
| LuminaireGeometry | [BoundaryRepresentation](/documentation/oM/Dimensional/Geometry/BoundaryRepresentation) | Boundary Representation of the LuminaireType's Geometry | - |
