...
{
 "$ref" : "https://raw.githubusercontent.com/BHoM/BHoM_JSONSchema/develop/Analytical_oM/Graph/Projection/GraphicalProjection.json"
}
```

The JSON Schema is available on github here:

- [GraphicalProjection.json](https://github.com/BHoM/BHoM_JSONSchema/blob/develop/Analytical_oM/Graph/Projection/GraphicalProjection.json)
