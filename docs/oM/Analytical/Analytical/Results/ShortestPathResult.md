...
{
 "$ref" : "https://raw.githubusercontent.com/BHoM/BHoM_JSONSchema/develop/Analytical_oM/Elements/ShortestPathResult.json"
}
```

The JSON Schema is available on github here:

- [ShortestPathResult.json](https://github.com/BHoM/BHoM_JSONSchema/blob/develop/Analytical_oM/Elements/ShortestPathResult.json)
