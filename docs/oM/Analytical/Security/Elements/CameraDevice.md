...
|------------------|------------------|------------------|------------------|
| EyePosition | [Point](/api/oM/Dimensional/Geometry/Point) | The point at which the Camera is installed, known as the eye position. | - |
| TargetPosition | [Point](/api/oM/Dimensional/Geometry/Point) | The point at which the Camera is looking at, known as the target position. | - |
...
| Centreline | [Line](/api/oM/Dimensional/Geometry/Line) | Returns the centreline of a CameraDevice object. | - | Security_Engine |
...
| Geometry | [ICurve](/api/oM/Dimensional/Geometry/ICurve) | Gets the camera's geometry as a closed ICurve cone-shape. Method required for automatic display in UI packages. | - | Security_Engine |
...
| ViewCone | [PolyCurve](/api/oM/Dimensional/Geometry/PolyCurve) | Returns the camera view cone. | - | Security_Engine |
