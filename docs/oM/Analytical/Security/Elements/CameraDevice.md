...
| HorizontalFieldOfView | [double](https://learn.microsoft.com/en-us/dotnet/api/System.Double?view=netstandard-2.0) | The horizontal field of view of the Camera, known as the real-world width length of what the camera views. | [Length](/api/oM/Dimensional/Quantities/Attributes/Length) [m] |
...
| ViewCone | [PolyCurve](/api/oM/Dimensional/Geometry/Curve/PolyCurve) | Returns the camera view cone. | - | Security_Engine |
