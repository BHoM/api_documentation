...
|------------------|------------------|------------------|------------------|
| EyePosition | [Point](/documentation/oM/Dimensional/Geometry/Point) | The point at which the Camera is installed, known as the eye position. | - |
| TargetPosition | [Point](/documentation/oM/Dimensional/Geometry/Point) | The point at which the Camera is looking at, known as the target position. | - |
| HorizontalFieldOfView | [double](https://learn.microsoft.com/en-us/dotnet/api/System.Double?view=netstandard-2.0) | The horizontal field of view of the Camera, known as the real-world width length of what the camera views. | [Length](/documentation/oM/Dimensional/Quantities/Attributes/Length) [m] |
| Mounting | [MountingType](/documentation/oM/Analytical/Security/Enums/MountingType) | The Camera mounting type that describes how it's installed. | - |
| Type | [CameraType](/documentation/oM/Analytical/Security/Enums/CameraType) | The Camera type that describes its characteristics. | - |
...
| Centreline | [Line](/documentation/oM/Dimensional/Geometry/Line) | Returns the centreline of a CameraDevice object. | - | Security_Engine |
...
| Geometry | [ICurve](/documentation/oM/Dimensional/Geometry/ICurve) | Gets the camera's geometry as a closed ICurve cone-shape. Method required for automatic display in UI packages. | - | Security_Engine |
...
| ViewCone | [PolyCurve](/documentation/oM/Dimensional/Geometry/PolyCurve) | Returns the camera view cone. | - | Security_Engine |
