...
???+ bhom "The Ray in inheriting from the following base type(s) and implements the following interfaces:"
...
|------------------|------------------|------------------|------------------|
| Path | [Polyline](/api_documentation/oM/Dimensional/Geometry/Polyline) | - | - |
...
| SoundLevel | [SoundLevel](/api_documentation/oM/Analytical/Acoustic/SoundLevel) | - | - | Acoustic_Engine |
