...
|------------------|------------------|------------------|------------------|
| Profile | [IProfile](/om_documentation/oM/Dimensional/Spatial/ShapeProfiles/IProfile) | Profile of the opening. | - |
| Depth | [double](https://learn.microsoft.com/en-us/dotnet/api/System.Double?view=netstandard-2.0) | Total depth of the opening, distributed equally from the origin in both directions along the local z axis. | [Length](/om_documentation/oM/Dimensional/Quantities/Attributes/Length) [m] |
| CoordinateSystem | [Cartesian](/om_documentation/oM/Dimensional/Geometry/CoordinateSystem/Cartesian) | Local coordinate system of the opening with local z being the direction along the opening, local x representing direction along width in plane and y along height respectively. | - |
...
| Geometry | [Point](/om_documentation/oM/Dimensional/Geometry/Point) | Extracts geometry of the given BuildersWork Opening. | - | Architecture_Engine |
