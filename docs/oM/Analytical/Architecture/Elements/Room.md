...
|------------------|------------------|------------------|------------------|
| Perimeter | [ICurve](/documentation/oM/Dimensional/Geometry/ICurve) | - | - |
| Location | [Point](/documentation/oM/Dimensional/Geometry/Point) | - | - |
...
| OutlineElements1D | [List](https://learn.microsoft.com/en-us/dotnet/api/System.Collections.Generic.List-1?view=netstandard-2.0)&lt;[IElement1D](/documentation/oM/Dimensional/Dimensional/IElement1D)&gt; | Returns the outline 1D elements of an Architecture Room | - | Architecture_Engine |
