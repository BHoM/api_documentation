...
{
 "$ref" : https://raw.githubusercontent.com/BHoM/BHoM_JSONSchema/develop/Architecture_oM/Theatron/VomitoryParameters.json}
```

The JSON Schema is available on github here:

- [VomitoryParameters.json](https://github.com/BHoM/BHoM_JSONSchema/blob/develop/Architecture_oM/Theatron/VomitoryParameters.json)
