...
| Tiers3d | [List](https://learn.microsoft.com/en-us/dotnet/api/System.Collections.Generic.List-1?view=netstandard-2.0)&lt;[Tier](/api/oM/Analytical/Architecture/Theatron/Tier)&gt; | - | - |
...
|------------------|------------------|------------------|------------------|------------------|
| Geometry | [CompositeGeometry](/api/oM/Dimensional/Geometry/CompositeGeometry) | Extracts geometry of the given Theatron. | - | Architecture_Engine |
