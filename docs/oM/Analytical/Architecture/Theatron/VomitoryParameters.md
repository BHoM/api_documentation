...
# Architecture.Theatron.VomitoryParameters
...
???+ bhom "The VomitoryParameters in inheriting from the following base type(s) and implements the following interfaces:"
