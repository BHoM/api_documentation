...
|------------------|------------------|------------------|------------------|
| Material | [Material](/api/oM/Analytical/EmbodiedSuffering/Elements/Material) | The name of the material that is imported to a particular country from other countries. | - |
| ExportCountries | [List](https://learn.microsoft.com/en-us/dotnet/api/System.Collections.Generic.List-1?view=netstandard-2.0)&lt;[Country](/api/oM/Analytical/EmbodiedSuffering/Elements/Country)&gt; | List of countries from which the material was imported. Count should match the import ratios. | - |
...
| ImportCountry | [Country](/api/oM/Analytical/EmbodiedSuffering/Elements/Country) | The name of the country in which the imported materials are utilised. | - |
