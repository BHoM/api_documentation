...
{
 "$ref" : "https://raw.githubusercontent.com/BHoM/BHoM_JSONSchema/develop/LifeCycleAssessment_oM/ILifeCycleAssessmentPhaseData.json"
}
```

The JSON Schema is available on github here:

- [ILifeCycleAssessmentPhaseData.json](https://github.com/BHoM/BHoM_JSONSchema/blob/develop/LifeCycleAssessment_oM/ILifeCycleAssessmentPhaseData.json)
