...
???+ bhom "The CurtainWall in inheriting from the following base type(s) and implements the following interfaces:"
    ...
    -  Analytical.Elements.[IPanel](/api_documentation/oM/Analytical/Analytical/Elements/IPanel%602)&lt;Facade.Elements.[FrameEdge](/api_documentation/oM/Analytical/Facade/Elements/FrameEdge), Facade.Elements.[Opening](/api_documentation/oM/Analytical/Facade/Elements/Opening)&gt;
...
|------------------|------------------|------------------|------------------|
| ExternalEdges | [List](https://learn.microsoft.com/en-us/dotnet/api/System.Collections.Generic.List-1?view=netstandard-2.0)&lt;[FrameEdge](/api_documentation/oM/Analytical/Facade/Elements/FrameEdge)&gt; | A collection of FrameEdge objects which defines the external boundary of the CurtainWall | - |
| Openings | [List](https://learn.microsoft.com/en-us/dotnet/api/System.Collections.Generic.List-1?view=netstandard-2.0)&lt;[Opening](/api_documentation/oM/Analytical/Facade/Elements/Opening)&gt; | A collection of all openings that make up the curtain wall | - |
...
| Geometry | [PlanarSurface](/api_documentation/oM/Dimensional/Geometry/PlanarSurface) | Gets the geometry of a CurtainWall at its centre. Method required for automatic display in UI packages. | - | Facade_Engine |
...
| MaterialComposition | [MaterialComposition](/api_documentation/oM/Physical/Physical/Materials/MaterialComposition) | Gets all the Materials a CurtainWall is composed of and in which ratios. | - | Facade_Engine |
...
| SolidVolume | [double](https://learn.microsoft.com/en-us/dotnet/api/System.Double?view=netstandard-2.0) | Returns a CurtainWall's solid volume. | [Volume](/api_documentation/oM/Dimensional/Quantities/Attributes/Volume) [m³] | Facade_Engine |
