...
???+ bhom "The Opening in inheriting from the following base type(s) and implements the following interfaces:"
    ...
    -  Analytical.Elements.[IOpening](/api/oM/Analytical/Analytical/Elements/IOpening%601)&lt;Facade.Elements.[FrameEdge](/api/oM/Analytical/Facade/Elements/FrameEdge)&gt;
...
| FrameCornerType | [FrameCornerType](/api/oM/Analytical/Facade/Elements/FrameCornerType) | Frame edge treatment at corners (ie Mitred, Vertical Extends, or Horizontal Extends) | - |
| Type | [OpeningType](/api/oM/Analytical/Facade/Elements/OpeningType) | The type of opening on a panel (e.g. Window, Door). Use OpeningType enum | - |
...
| FrameGeometry2D | [IGeometry](/api/oM/Dimensional/Geometry/IGeometry) | Returns 2D Geometry representing the frame's projected elevation extents | - | Facade_Engine |
...
| Geometry | [PolyCurve](/api/oM/Dimensional/Geometry/PolyCurve) | Gets the geometry of a facade Opening as an outline curve. Method required for automatic display in UI packages. | - | Facade_Engine |
