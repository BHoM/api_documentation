...
???+ bhom "The Opening in inheriting from the following base type(s) and implements the following interfaces:"
    ...
    -  Analytical.Elements.[IOpening](/documentation/oM/Analytical/Analytical/Elements/IOpening%601)&lt;Facade.Elements.[FrameEdge](/documentation/oM/Analytical/Facade/Elements/FrameEdge)&gt;
...
|------------------|------------------|------------------|------------------|
| Edges | [List](https://learn.microsoft.com/en-us/dotnet/api/System.Collections.Generic.List-1?view=netstandard-2.0)&lt;[FrameEdge](/documentation/oM/Analytical/Facade/Elements/FrameEdge)&gt; | A collection of FrameEdges which define the external boundary of the opening. | - |
| OpeningConstruction | [IConstruction](/documentation/oM/Physical/Physical/Constructions/IConstruction) | A construction object providing construction information about the opening - typically glazing construction | - |
| FrameCornerType | [FrameCornerType](/documentation/oM/Analytical/Facade/Elements/FrameCornerType) | Frame edge treatment at corners (ie Mitred, Vertical Extends, or Horizontal Extends) | - |
| Type | [OpeningType](/documentation/oM/Analytical/Facade/Elements/OpeningType) | The type of opening on a panel (e.g. Window, Door). Use OpeningType enum | - |
...
| FrameGeometry2D | [IGeometry](/documentation/oM/Dimensional/Geometry/IGeometry) | Returns 2D Geometry representing the frame's projected elevation extents | - | Facade_Engine |
| GeneralMaterialTakeoff | [GeneralMaterialTakeoff](/documentation/oM/Physical/Physical/Materials/GeneralMaterialTakeoff) | Gets the volumetric material takeoff from the Opening. | - | Facade_Engine |
| Geometry | [PolyCurve](/documentation/oM/Dimensional/Geometry/PolyCurve) | Gets the geometry of a facade Opening as an outline curve. Method required for automatic display in UI packages. | - | Facade_Engine |
...
| MaterialComposition | [MaterialComposition](/documentation/oM/Physical/Physical/Materials/MaterialComposition) | Gets all the Materials an Opening is composed of and in which ratios. | - | Facade_Engine |
...
| SolidVolume | [double](https://learn.microsoft.com/en-us/dotnet/api/System.Double?view=netstandard-2.0) | Returns an Openings solid volume based on its area, and construction thickness | [Volume](/documentation/oM/Dimensional/Quantities/Attributes/Volume) [m³] | Facade_Engine |
