...
???+ bhom "The FrameEdge in inheriting from the following base type(s) and implements the following interfaces:"
...
|------------------|------------------|------------------|------------------|
| Curve | [ICurve](/api/oM/Dimensional/Geometry/ICurve) | The curve representing the frame edge location | - |
