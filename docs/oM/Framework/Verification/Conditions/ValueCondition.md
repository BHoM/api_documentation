...
| ComparisonType | [ValueComparisonType](/documentation/oM/Framework/Verification/ValueComparisonType) | Specifies whether the extracted value should be smaller, greater, etc. than the reference value. | - |
