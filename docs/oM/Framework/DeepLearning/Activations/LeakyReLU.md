...
{
 "$ref" : "https://raw.githubusercontent.com/BHoM/BHoM_JSONSchema/develop/DeepLearning_oM/Activations/LeakyReLU.json"
}
```

The JSON Schema is available on github here:

- [LeakyReLU.json](https://github.com/BHoM/BHoM_JSONSchema/blob/develop/DeepLearning_oM/Activations/LeakyReLU.json)
