...
{
 "$ref" : https://raw.githubusercontent.com/BHoM/BHoM_JSONSchema/develop/DeepLearning_oM/Activations/LogSoftmax.json}
```

The JSON Schema is available on github here:

- [LogSoftmax.json](https://github.com/BHoM/BHoM_JSONSchema/blob/develop/DeepLearning_oM/Activations/LogSoftmax.json)
