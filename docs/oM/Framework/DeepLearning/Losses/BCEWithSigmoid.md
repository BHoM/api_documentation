...
{
 "$ref" : "https://raw.githubusercontent.com/BHoM/BHoM_JSONSchema/develop/DeepLearning_oM/Losses/BCEWithSigmoid.json"
}
```

The JSON Schema is available on github here:

- [BCEWithSigmoid.json](https://github.com/BHoM/BHoM_JSONSchema/blob/develop/DeepLearning_oM/Losses/BCEWithSigmoid.json)
