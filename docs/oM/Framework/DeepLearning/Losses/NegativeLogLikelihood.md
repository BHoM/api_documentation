...
# DeepLearning.Losses.NegativeLogLikelihood
...
???+ bhom "The NegativeLogLikelihood in inheriting from the following base type(s) and implements the following interfaces:"
...
|------------------|------------------|------------------|------------------|
| Reduce | [Reduce](/om_documentation/oM/Framework/DeepLearning/Reduce) | - | - |
