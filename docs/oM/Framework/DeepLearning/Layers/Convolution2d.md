...
{
 "$ref" : "https://raw.githubusercontent.com/BHoM/BHoM_JSONSchema/develop/DeepLearning_oM/Layers/Convolution2d.json"
}
```

The JSON Schema is available on github here:

- [Convolution2d.json](https://github.com/BHoM/BHoM_JSONSchema/blob/develop/DeepLearning_oM/Layers/Convolution2d.json)
