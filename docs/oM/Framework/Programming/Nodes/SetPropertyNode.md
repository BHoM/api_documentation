...
{
 "$ref" : "https://raw.githubusercontent.com/BHoM/BHoM_JSONSchema/develop/Programming_oM/SetPropertyNode.json"
}
```

The JSON Schema is available on github here:

- [SetPropertyNode.json](https://github.com/BHoM/BHoM_JSONSchema/blob/develop/Programming_oM/SetPropertyNode.json)
