...
{
 "$ref" : "https://raw.githubusercontent.com/BHoM/BHoM_JSONSchema/develop/Programming_oM/ConstructorNode.json"
}
```

The JSON Schema is available on github here:

- [ConstructorNode.json](https://github.com/BHoM/BHoM_JSONSchema/blob/develop/Programming_oM/ConstructorNode.json)
