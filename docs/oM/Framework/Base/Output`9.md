---
title: Output&lt;T1,T2,T3,T4,T5,T6,T7,T8,T9&gt;
---

# Base.Output&lt;T1,T2,T3,T4,T5,T6,T7,T8,T9&gt;
...
???+ bhom "The Output`9 in inheriting from the following base type(s) and implements the following interfaces:"
