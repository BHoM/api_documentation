---
title: Output&lt;T1,T2,T3,T4,T5,T6,T7,T8&gt;
---

# Base.Output&lt;T1,T2,T3,T4,T5,T6,T7,T8&gt;
...
???+ bhom "The Output`8 in inheriting from the following base type(s) and implements the following interfaces:"
