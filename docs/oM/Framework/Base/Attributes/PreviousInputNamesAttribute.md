...
{
 "$ref" : "https://raw.githubusercontent.com/BHoM/BHoM_JSONSchema/develop/BHoM/Attributes/PreviousInputNamesAttribute.json"
}
```

The JSON Schema is available on github here:

- [PreviousInputNamesAttribute.json](https://github.com/BHoM/BHoM_JSONSchema/blob/develop/BHoM/Attributes/PreviousInputNamesAttribute.json)
