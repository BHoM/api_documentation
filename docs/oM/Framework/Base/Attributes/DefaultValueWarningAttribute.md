...
# Base.Attributes.DefaultValueWarningAttribute
...
???+ bhom "The DefaultValueWarningAttribute in inheriting from the following base type(s) and implements the following interfaces:"
