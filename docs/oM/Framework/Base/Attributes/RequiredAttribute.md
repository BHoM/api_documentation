...
{
 "$ref" : "https://raw.githubusercontent.com/BHoM/BHoM_JSONSchema/develop/BHoM/Attributes/RequiredAttribute.json"
}
```

The JSON Schema is available on github here:

- [RequiredAttribute.json](https://github.com/BHoM/BHoM_JSONSchema/blob/develop/BHoM/Attributes/RequiredAttribute.json)
