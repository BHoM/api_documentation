...
|------------------|------------------|------------------|------------------|
| Requests | [List](https://learn.microsoft.com/en-us/dotnet/api/System.Collections.Generic.List-1?view=netstandard-2.0)&lt;[IRequest](/api_documentation/oM/Framework/Data/Requests/IRequest)&gt; | IRequests to be combined into a logical OR statement. | - |
