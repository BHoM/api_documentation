...
| Status | [TestStatus](/om_documentation/oM/Framework/Test/TestStatus) | States whether the test was a success or not. Defaults to Error to ensure any defaults are investigated appropriately. | - |
| Information | [List](https://learn.microsoft.com/en-us/dotnet/api/System.Collections.Generic.List-1?view=netstandard-2.0)&lt;[ITestInformation](/om_documentation/oM/Framework/Test/ITestInformation)&gt; | Information generated during the test. | - |
