...
???+ bhom "The RenderPoint in inheriting from the following base type(s) and implements the following interfaces:"
...
|------------------|------------------|------------------|------------------|
| Point | [Point](/api/oM/Dimensional/Geometry/Point) | - | - |
...
|------------------|------------------|------------------|------------------|------------------|
| Bounds | [BoundingBox](/api/oM/Dimensional/Geometry/BoundingBox) | Computes and returns the BoundingBox of the RenderPoint as the bounding box of its Point. | - | Graphics_Engine |
...
| Geometry | [IGeometry](/api/oM/Dimensional/Geometry/IGeometry) | Query the geometry that define the input RenderPoint. | - | Graphics_Engine |
