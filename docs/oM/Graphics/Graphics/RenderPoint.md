...
|------------------|------------------|------------------|------------------|
| Point | [Point](/om_documentation/oM/Dimensional/Geometry/Point) | - | - |
...
|------------------|------------------|------------------|------------------|------------------|
| Bounds | [BoundingBox](/om_documentation/oM/Dimensional/Geometry/BoundingBox) | Computes and returns the BoundingBox of the RenderPoint as the bounding box of its Point. | - | Graphics_Engine |
...
| Geometry | [IGeometry](/om_documentation/oM/Dimensional/Geometry/IGeometry) | Query the geometry that define the input RenderPoint. | - | Graphics_Engine |
