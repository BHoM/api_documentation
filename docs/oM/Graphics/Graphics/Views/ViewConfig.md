...
???+ bhom "The ViewConfig in inheriting from the following base type(s) and implements the following interfaces:"
...
| Padding | [Padding](/api_documentation/oM/Graphics/Graphics/Misc/Padding) | - | - |
