...
|------------------|------------------|------------------|------------------|
| RepresentationOptions | [RepresentationOptions](/documentation/oM/Graphics/Graphics/RepresentationOptions) | Regulate how the Representation of the objects is computed. | - |
