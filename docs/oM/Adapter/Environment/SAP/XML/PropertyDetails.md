...
|------------------|------------------|------------------|------------------|
| EnergySource | [EnergySource](/documentation/oM/Adapter/Environment/SAP/XML/EnergySource) | . | - |
| Heating | [Heating](/documentation/oM/Adapter/Environment/SAP/XML/Heating) | . | - |
| BuildingParts | [BuildingParts](/documentation/oM/Adapter/Environment/SAP/XML/BuildingParts) | Details of the significant building parts that comprise the main habitable building in the property. | - |
| Ventilation | [Ventilation](/documentation/oM/Adapter/Environment/SAP/XML/Ventilation) | Details of the means by which the building is ventilated | - |
| OpeningTypes | [OpeningTypes](/documentation/oM/Adapter/Environment/SAP/XML/OpeningTypes) | Types of exposed openings that make up a particular property. | - |
...
| Lighting | [Lighting](/documentation/oM/Adapter/Environment/SAP/XML/Lighting) | Details of the main lighting for the property | - |
...
| DeselectedImprovements | [DeselectedImprovements](/documentation/oM/Adapter/Environment/SAP/XML/DeselectedImprovements) | . | - |
| FlatDetails | [FlatDetails](/documentation/oM/Adapter/Environment/SAP/XML/FlatDetails) | Detials of location of flat in building | - |
| SpecialFeatures | [SpecialFeatures](/documentation/oM/Adapter/Environment/SAP/XML/SpecialFeatures) | . | - |
...
| Cooling | [Cooling](/documentation/oM/Adapter/Environment/SAP/XML/Cooling) | . | - |
