...
| FGHRSEnergySource | [EnergySource](/api/oM/Adapter/Environment/SAP/XML/EnergySource) | . | - |
| MainHeatingDeclaredValues | [HeatingDeclaredValues](/api/oM/Adapter/Environment/SAP/XML/HeatingDeclaredValues) | . | - |
| StorageHeaters | [StorageHeaters](/api/oM/Adapter/Environment/SAP/XML/StorageHeaters) | . | - |
