...
|------------------|------------------|------------------|------------------|
| MainHeatingDetails | [MainHeatingDetails](/api/oM/Adapter/Environment/SAP/XML/MainHeatingDetails) | . | - |
...
| CommunityHeatingSystems | [CommunityHeatingSystems](/api/oM/Adapter/Environment/SAP/XML/CommunityHeatingSystems) | Community heating systems used by the property. | - |
...
| SecondaryHeatingDeclaredValues | [HeatingDeclaredValues](/api/oM/Adapter/Environment/SAP/XML/HeatingDeclaredValues) | Use when manufacturer’s declared values. | - |
| SolarHeatingDetails | [SolarHeatingDetails](/api/oM/Adapter/Environment/SAP/XML/SolarHeatingDetails) | . | - |
| StorageWHRS | [StorageWWHRS](/api/oM/Adapter/Environment/SAP/XML/StorageWWHRS) | . | - |
...
| ShowerOutlets | [ShowerOutlets](/api/oM/Adapter/Environment/SAP/XML/ShowerOutlets) | . | - |
...
| InstantaneousWHRS | [InstantaneousWWHRS](/api/oM/Adapter/Environment/SAP/XML/InstantaneousWWHRS) | Waste Water Heat Recovery System. | - |
