...
| DwellingOrientation | [OrientationCode](/api/oM/Adapter/Environment/SAP/OrientationCode) | The storey the roof is located on. | - |
...
| PropertyType | [TypeOfProperty](/api/oM/Adapter/Environment/SAP/TypeOfProperty) | The type of property for this dwelling. | - |
| ConstructionType | [DataTypeCode](/api/oM/Adapter/Environment/SAP/DataTypeCode) | The type of construction for this dwelling (new build, refurb, etc.). | - |
