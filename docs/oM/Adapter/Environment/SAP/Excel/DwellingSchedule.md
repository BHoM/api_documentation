...
| DwellingOrientation | [OrientationCode](/documentation/oM/Adapter/Environment/SAP/OrientationCode) | The storey the roof is located on. | - |
...
| PropertyType | [TypeOfProperty](/documentation/oM/Adapter/Environment/SAP/TypeOfProperty) | The type of property for this dwelling. | - |
| ConstructionType | [DataTypeCode](/documentation/oM/Adapter/Environment/SAP/DataTypeCode) | The type of construction for this dwelling (new build, refurb, etc.). | - |
