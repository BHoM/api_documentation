...
# Environment.SAP.Excel.WallSchedule
...
???+ bhom "The WallSchedule in inheriting from the following base type(s) and implements the following interfaces:"
...
| Type | [TypeOfWall](/api_documentation/oM/Adapter/Environment/SAP/TypeOfWall) | The type of wall | - |
