...
# Environment.SAP.Excel.FloorSchedule
...
???+ bhom "The FloorSchedule in inheriting from the following base type(s) and implements the following interfaces:"
...
| Type | [TypeOfFloor](/api_documentation/oM/Adapter/Environment/SAP/TypeOfFloor) | The type of floor | - |
