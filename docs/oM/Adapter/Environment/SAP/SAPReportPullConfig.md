...
# Environment.SAP.SAPReportPullConfig
...
|------------------|------------------|------------------|------------------|
| SAPReportFile | [FileSettings](/om_documentation/oM/Framework/Adapter/FileSettings) | Set the location of the SAP XML Report file. | - |
