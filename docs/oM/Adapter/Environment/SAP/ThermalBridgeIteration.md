...
# Environment.SAP.ThermalBridgeIteration
...
???+ bhom "The ThermalBridgeIteration in inheriting from the following base type(s) and implements the following interfaces:"
...
|------------------|------------------|------------------|------------------|
| Values | [List](https://learn.microsoft.com/en-us/dotnet/api/System.Collections.Generic.List-1?view=netstandard-2.0)&lt;[ThermalBridgeValue](/api_documentation/oM/Adapter/Environment/SAP/ThermalBridgeValue)&gt; | A collection of Thermal Bridge Values to group as a single iteration for parametrics. | - |
