...
|------------------|------------------|------------------|------------------|
| FileSettingsInput | [FileSettings](/documentation/oM/Framework/Adapter/FileSettings) | Path to XML file that will be calculated. | - |
| FileSettingsOutput | [FileSettings](/documentation/oM/Framework/Adapter/FileSettings) | Path to new file, if using txt endpoint. | - |
