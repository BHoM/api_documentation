...
???+ bhom "The AirPermeabilityIteration is inheriting from the following base type(s) and implements the following interfaces:"
...
``` C# title="C#"
public class AirPermeabilityIteration : BH.oM.Base.BHoMObject, BH.oM.Base.IBHoMObject, BH.oM.Base.IObject, BH.oM.Environment.SAP.IIteration
```
...
{
 "$ref" : "https://raw.githubusercontent.com/BHoM/BHoM_JSONSchema/develop/SAP_oM/SAP/XML/AirPermeabilityIteration.json"
}
```

The JSON Schema is available on github here:

- [AirPermeabilityIteration.json](https://github.com/BHoM/BHoM_JSONSchema/blob/develop/SAP_oM/SAP/XML/AirPermeabilityIteration.json)
