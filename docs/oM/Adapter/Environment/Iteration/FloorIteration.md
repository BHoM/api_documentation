...
# <small>BH.oM.Environment.SAP.XML.</small>**FloorIteration**
...
???+ bhom "The FloorIteration is inheriting from the following base type(s) and implements the following interfaces:"
...
``` C# title="C#"
public class FloorIteration : BH.oM.Base.BHoMObject, BH.oM.Base.IBHoMObject, BH.oM.Base.IObject, BH.oM.Environment.SAP.IIteration
```
...
{
 "$ref" : "https://raw.githubusercontent.com/BHoM/BHoM_JSONSchema/develop/SAP_oM/SAP/XML/FloorIteration.json"
}
```

The JSON Schema is available on github here:

- [FloorIteration.json](https://github.com/BHoM/BHoM_JSONSchema/blob/develop/SAP_oM/SAP/XML/FloorIteration.json)
