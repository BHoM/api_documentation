...
{
 "$ref" : "https://raw.githubusercontent.com/BHoM/BHoM_JSONSchema/develop/SAP_oM/SAP/Excel/OpeningPsiValueSchedule.json"
}
```

The JSON Schema is available on github here:

- [OpeningPsiValueSchedule.json](https://github.com/BHoM/BHoM_JSONSchema/blob/develop/SAP_oM/SAP/Excel/OpeningPsiValueSchedule.json)
