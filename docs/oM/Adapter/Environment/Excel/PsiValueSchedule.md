...
{
 "$ref" : "https://raw.githubusercontent.com/BHoM/BHoM_JSONSchema/develop/SAP_oM/SAP/Excel/PsiValueSchedule.json"
}
```

The JSON Schema is available on github here:

- [PsiValueSchedule.json](https://github.com/BHoM/BHoM_JSONSchema/blob/develop/SAP_oM/SAP/Excel/PsiValueSchedule.json)
