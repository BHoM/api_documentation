...
???+ bhom "The Shelter is inheriting from the following base type(s) and implements the following interfaces:"
...
| Vertices | [List](https://learn.microsoft.com/en-us/dotnet/api/System.Collections.Generic.List-1?view=netstandard-2.0)&lt;[Point](/api/oM/Dimensional/Geometry/Vector/Point)&gt; | The vertices of this shelter object. | - |
...
``` C# title="C#"
public class Shelter : BH.oM.Base.BHoMObject, BH.oM.Base.IBHoMObject, BH.oM.Base.IObject, BH.oM.LadybugTools.ILadybugTools
```
...
{
 "$ref" : "https://raw.githubusercontent.com/BHoM/BHoM_JSONSchema/develop/LadybugTools_oM/Shelter.json"
}
```

The JSON Schema is available on github here:

- [Shelter.json](https://github.com/BHoM/BHoM_JSONSchema/blob/develop/LadybugTools_oM/Shelter.json)
