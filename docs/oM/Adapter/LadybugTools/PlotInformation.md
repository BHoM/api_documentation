...
???+ bhom "The PlotInformation in inheriting from the following base type(s) and implements the following interfaces:"
...
| OtherData | [ISimulationData](/api_documentation/oM/Adapter/LadybugTools/ISimulationData) | Metadata about the data used to produce the image. | - |
