...
|------------------|------------------|------------------|------------------|
| DataType | [DataType](/documentation/oM/Adapter/LadybugTools/DataType) | The data type the data associated with this header object represents. | - |
...
| AnalysisPeriod | [AnalysisPeriod](/documentation/oM/Adapter/LadybugTools/AnalysisPeriod) | The analysis period associated with this header object. | - |
