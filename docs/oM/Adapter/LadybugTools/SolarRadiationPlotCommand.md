...
|------------------|------------------|------------------|------------------|
| EPWFile | [FileSettings](/api_documentation/oM/Framework/Adapter/FileSettings) | The EPW file to use for simulation. | - |
...
| IrradianceType | [IrradianceType](/api_documentation/oM/Adapter/LadybugTools/IrradianceType) | The irradiance type to plot. Total for all. | - |
| AnalysisPeriod | [AnalysisPeriod](/api_documentation/oM/Adapter/LadybugTools/AnalysisPeriod) | The analysis period to simulate/plot. | - |
