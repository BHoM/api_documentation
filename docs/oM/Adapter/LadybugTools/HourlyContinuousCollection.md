...
# LadybugTools.HourlyContinuousCollection
...
???+ bhom "The HourlyContinuousCollection in inheriting from the following base type(s) and implements the following interfaces:"
...
|------------------|------------------|------------------|------------------|
| Header | [Header](/api_documentation/oM/Adapter/LadybugTools/Header) | An approximation of a Ladybug Header object. | - |
