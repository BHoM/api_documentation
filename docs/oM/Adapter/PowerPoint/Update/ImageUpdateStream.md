...
???+ bhom "The ImageUpdateStream is inheriting from the following base type(s) and implements the following interfaces:"
...
``` C# title="C#"
public class ImageUpdateStream : BH.oM.Base.BHoMObject,
...
{
 "$ref" : "https://raw.githubusercontent.com/BHoM/BHoM_JSONSchema/develop/PowerPoint_oM/ImageUpdateStream.json"
}
```

The JSON Schema is available on github here:

- [ImageUpdateStream.json](https://github.com/BHoM/BHoM_JSONSchema/blob/develop/PowerPoint_oM/ImageUpdateStream.json)
