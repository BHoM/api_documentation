...
???+ bhom "The SimpleTextUpdate is inheriting from the following base type(s) and implements the following interfaces:"
...
| Text | [string](https://learn.microsoft.com/en-us/dotnet/api/System.String?view=netstandard-2.0) | New text for the element. | - |
...
``` C# title="C#"
public class SimpleTextUpdate : BH.oM.Base.BHoMObject,
...
- [SimpleTextUpdate.cs](https://github.com/BHoM/PowerPoint_Toolkit/blob/develop/PowerPoint_oM/Update\SimpleTextUpdate.cs)
...
{
 "$ref" : "https://raw.githubusercontent.com/BHoM/BHoM_JSONSchema/develop/PowerPoint_oM/SimpleTextUpdate.json"
}
```

The JSON Schema is available on github here:

- [SimpleTextUpdate.json](https://github.com/BHoM/BHoM_JSONSchema/blob/develop/PowerPoint_oM/SimpleTextUpdate.json)
