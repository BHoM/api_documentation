...
???+ bhom "The ImageUpdate is inheriting from the following base type(s) and implements the following interfaces:"
...
``` C# title="C#"
public class ImageUpdate : BH.oM.Base.BHoMObject,
...
{
 "$ref" : "https://raw.githubusercontent.com/BHoM/BHoM_JSONSchema/develop/PowerPoint_oM/ImageUpdate.json"
}
```

The JSON Schema is available on github here:

- [ImageUpdate.json](https://github.com/BHoM/BHoM_JSONSchema/blob/develop/PowerPoint_oM/ImageUpdate.json)
