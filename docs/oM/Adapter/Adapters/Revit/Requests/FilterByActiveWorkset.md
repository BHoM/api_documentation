...
# Adapters.Revit.Requests.FilterByActiveWorkset
...
???+ bhom "The FilterByActiveWorkset in inheriting from the following base type(s) and implements the following interfaces:"
