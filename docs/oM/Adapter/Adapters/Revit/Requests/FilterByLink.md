...
# <small>BH.oM.Adapters.Revit.Requests.</small>**FilterByLink**
...
???+ bhom "The FilterByLink is inheriting from the following base type(s) and implements the following interfaces:"
...
``` C# title="C#"
public class FilterByLink : BH.oM.Data.Requests.IRequest, BH.oM.Base.IObject
```
...
{
 "$ref" : "https://raw.githubusercontent.com/BHoM/BHoM_JSONSchema/develop/Revit_oM/Requests/FilterByLink.json"
}
```

The JSON Schema is available on github here:

- [FilterByLink.json](https://github.com/BHoM/BHoM_JSONSchema/blob/develop/Revit_oM/Requests/FilterByLink.json)
