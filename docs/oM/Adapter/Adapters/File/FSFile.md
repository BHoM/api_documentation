...
|------------------|------------------|------------------|------------------|
| ParentDirectory | [FSDirectory](/documentation/oM/Adapter/Adapters/File/FSDirectory) | Full path of parent Directory of the File. You can also specify a string path. | - |
