...
# Adapters.RAM.RAMFactoredEndReactions
...
???+ bhom "The RAMFactoredEndReactions in inheriting from the following base type(s) and implements the following interfaces:"
