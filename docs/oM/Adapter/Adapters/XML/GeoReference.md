...
|------------------|------------------|------------------|------------------|
| NorthVector | [Vector](/documentation/oM/Dimensional/Geometry/Vector) | - | - |
| Reference | [Point](/documentation/oM/Dimensional/Geometry/Point) | - | - |
...
| AltitudeMode | [AltitudeMode](/documentation/oM/Adapter/Adapters/XML/Enums/AltitudeMode) | - | - |
