...
|------------------|------------------|------------------|------------------|
| NorthVector | [Vector](/om_documentation/oM/Dimensional/Geometry/Vector) | - | - |
| Reference | [Point](/om_documentation/oM/Dimensional/Geometry/Point) | - | - |
...
| AltitudeMode | [AltitudeMode](/om_documentation/oM/Adapter/Adapters/XML/Enums/AltitudeMode) | - | - |
