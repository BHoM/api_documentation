...
{
 "$ref" : "https://raw.githubusercontent.com/BHoM/BHoM_JSONSchema/develop/SAP2000_oM/Requests/SteelUtilisationRequest.json"
}
```

The JSON Schema is available on github here:

- [SteelUtilisationRequest.json](https://github.com/BHoM/BHoM_JSONSchema/blob/develop/SAP2000_oM/Requests/SteelUtilisationRequest.json)
