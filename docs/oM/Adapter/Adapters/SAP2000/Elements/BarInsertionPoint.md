...
|------------------|------------------|------------------|------------------|
| InsertionPoint | [BarInsertionPointLocation](/documentation/oM/Adapter/Adapters/SAP2000/BarInsertionPointLocation) | Bar insertion point based on cross section. | - |
