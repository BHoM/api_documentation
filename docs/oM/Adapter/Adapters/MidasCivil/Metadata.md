...
| Reviews | [List](https://learn.microsoft.com/en-us/dotnet/api/System.Collections.Generic.List-1?view=netstandard-2.0)&lt;[Review](/om_documentation/oM/Adapter/Adapters/MidasCivil/Review)&gt; | A list of reviews containing reviewers, their comments and the date of review. | - |
