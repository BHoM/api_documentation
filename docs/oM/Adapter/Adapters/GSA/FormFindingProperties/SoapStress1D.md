...
# Adapters.GSA.FormFindingProperties.SoapStress1D
...
???+ bhom "The SoapStress1D in inheriting from the following base type(s) and implements the following interfaces:"
