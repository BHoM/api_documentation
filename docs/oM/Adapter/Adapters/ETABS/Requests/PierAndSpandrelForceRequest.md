...
# Adapters.ETABS.Requests.PierAndSpandrelForceRequest
...
???+ bhom "The PierAndSpandrelForceRequest in inheriting from the following base type(s) and implements the following interfaces:"
...
|------------------|------------------|------------------|------------------|
| ResultType | [PierAndSpandrelResultType](/api_documentation/oM/Adapter/Adapters/ETABS/Requests/PierAndSpandrelResultType) | Defines which type of results that should be extracted. | - |
