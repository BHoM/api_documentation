...
|------------------|------------------|------------------|------------------|
| ResultType | [PierAndSpandrelResultType](/om_documentation/oM/Adapter/Adapters/ETABS/Requests/PierAndSpandrelResultType) | Defines which type of results that should be extracted. | - |
