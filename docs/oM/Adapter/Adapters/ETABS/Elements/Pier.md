...
# <small>BH.oM.Adapters.ETABS.Elements.</small>**Pier**
...
{
 "$ref" : https://raw.githubusercontent.com/BHoM/BHoM_JSONSchema/develop/ETABS_oM/Elements/Pier.json}
```

The JSON Schema is available on github here:

- [Pier.json](https://github.com/BHoM/BHoM_JSONSchema/blob/develop/ETABS_oM/Elements/Pier.json)
