...
{
 "$ref" : "https://raw.githubusercontent.com/BHoM/BHoM_JSONSchema/develop/OpenStreetMap_oM/ElementContainer.json"
}
```

The JSON Schema is available on github here:

- [ElementContainer.json](https://github.com/BHoM/BHoM_JSONSchema/blob/develop/OpenStreetMap_oM/ElementContainer.json)
