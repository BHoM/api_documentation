...
# <small>BH.oM.Adapters.Robot.</small>**InteractiveSettings**
...
{
 "$ref" : "https://raw.githubusercontent.com/BHoM/BHoM_JSONSchema/develop/Robot_oM/InteractiveSettings.json"
}
```

The JSON Schema is available on github here:

- [InteractiveSettings.json](https://github.com/BHoM/BHoM_JSONSchema/blob/develop/Robot_oM/InteractiveSettings.json)
