...
- [PeakDesignSensibleLoad.cs](https://github.com/BHoM/XML_Toolkit/blob/develop/XML_oM/EnergyPlus\PeakDesignSensibleLoad.cs)
...
{
 "$ref" : https://raw.githubusercontent.com/BHoM/BHoM_JSONSchema/develop/XML_oM/EnergyPlus/PeakDesignSensibleLoad.json}
```

The JSON Schema is available on github here:

- [PeakDesignSensibleLoad.json](https://github.com/BHoM/BHoM_JSONSchema/blob/develop/XML_oM/EnergyPlus/PeakDesignSensibleLoad.json)
