...
# <small>BH.oM.XML.EnergyPlus.</small>**Difference**
...
- [Difference.cs](https://github.com/BHoM/XML_Toolkit/blob/develop/XML_oM/EnergyPlus\Difference.cs)
...
{
 "$ref" : https://raw.githubusercontent.com/BHoM/BHoM_JSONSchema/develop/XML_oM/EnergyPlus/Difference.json}
```

The JSON Schema is available on github here:

- [Difference.json](https://github.com/BHoM/BHoM_JSONSchema/blob/develop/XML_oM/EnergyPlus/Difference.json)
