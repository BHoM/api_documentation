...
# XML.EnergyPlus.OutsideHumidityRatioAtPeak
...
???+ bhom "The OutsideHumidityRatioAtPeak in inheriting from the following base type(s) and implements the following interfaces:"
