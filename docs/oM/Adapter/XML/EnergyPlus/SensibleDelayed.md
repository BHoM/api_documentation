...
{
 "$ref" : https://raw.githubusercontent.com/BHoM/BHoM_JSONSchema/develop/XML_oM/EnergyPlus/SensibleDelayed.json}
```

The JSON Schema is available on github here:

- [SensibleDelayed.json](https://github.com/BHoM/BHoM_JSONSchema/blob/develop/XML_oM/EnergyPlus/SensibleDelayed.json)
