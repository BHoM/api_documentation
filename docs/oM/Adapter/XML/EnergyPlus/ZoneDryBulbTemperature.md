...
# XML.EnergyPlus.ZoneDryBulbTemperature
...
???+ bhom "The ZoneDryBulbTemperature in inheriting from the following base type(s) and implements the following interfaces:"
