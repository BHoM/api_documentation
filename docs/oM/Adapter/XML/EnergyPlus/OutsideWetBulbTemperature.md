...
# XML.EnergyPlus.OutsideWetBulbTemperature
...
???+ bhom "The OutsideWetBulbTemperature in inheriting from the following base type(s) and implements the following interfaces:"
