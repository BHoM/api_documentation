...
|------------------|------------------|------------------|------------------|
| Surfaces | [List](https://learn.microsoft.com/en-us/dotnet/api/System.Collections.Generic.List-1?view=netstandard-2.0)&lt;[ISurface](/api_documentation/oM/Dimensional/Geometry/ISurface)&gt; | A collection of surfaces, of any or mixed type, which together define the composite shape. | - |
...
| ExternalEdges | [List](https://learn.microsoft.com/en-us/dotnet/api/System.Collections.Generic.List-1?view=netstandard-2.0)&lt;[ICurve](/api_documentation/oM/Dimensional/Geometry/ICurve)&gt; | Gets the external edge curves of the PolySurface the external edge curves of all of its parts. | - | Geometry_Engine |
...
| SubParts | [List](https://learn.microsoft.com/en-us/dotnet/api/System.Collections.Generic.List-1?view=netstandard-2.0)&lt;[ISurface](/api_documentation/oM/Dimensional/Geometry/ISurface)&gt; | - | - | Geometry_Engine |
