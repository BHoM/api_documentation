...
|------------------|------------------|------------------|------------------|
| X | [Vector](/documentation/oM/Dimensional/Geometry/Vector) | Unit vector defining local x coordinate axis | - |
| Y | [Vector](/documentation/oM/Dimensional/Geometry/Vector) | Unit vector defining local y coordinate axis | - |
| Z | [Vector](/documentation/oM/Dimensional/Geometry/Vector) | Unit vector defining local z coordinate axis | - |
| Origin | [Point](/documentation/oM/Dimensional/Geometry/Point) | Location point in three-dimensional space defining (0,0,0) and the origin for each axis | - |
