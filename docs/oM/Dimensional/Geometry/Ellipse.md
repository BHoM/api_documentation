...
???+ bhom "The Ellipse in inheriting from the following base type(s) and implements the following interfaces:"
...
|------------------|------------------|------------------|------------------|
| Centre | [Point](/api/oM/Dimensional/Geometry/Point) | Origin point defining location of the Ellipse in three-dimensional space. | - |
| Axis1 | [Vector](/api/oM/Dimensional/Geometry/Vector) | Together with Axis2 defines orientation in three-dimensional space. Direction only, and not magnitude, matters. | - |
| Axis2 | [Vector](/api/oM/Dimensional/Geometry/Vector) | Together with Axis1 defines orientation in three-dimensional space. Direction only, and not magnitude, matters. | - |
...
| Centroid | [Point](/api/oM/Dimensional/Geometry/Point) | Queries the centre of area for an Ellipse. | - | Geometry_Engine |
...
| ControlPoints | [List](https://learn.microsoft.com/en-us/dotnet/api/System.Collections.Generic.List-1?view=netstandard-2.0)&lt;[Point](/api/oM/Dimensional/Geometry/Point)&gt; | Gets points at the vertices and co-vertices of the Ellipse. | - | Geometry_Engine |
...
| EndDir | [Vector](/api/oM/Dimensional/Geometry/Vector) | Gets the tangent vector at the end of the Ellipse. An ellipse starts and ends at the first axis point, and move towards the second axis, hence second axis is the tangent at start and end. | - | Geometry_Engine |
| EndPoint | [Point](/api/oM/Dimensional/Geometry/Point) | - | - | Geometry_Engine |
| FocalPoints | [Output](/api/oM/Framework/Base/Output%602)&lt;[Point](/api/oM/Dimensional/Geometry/Point), [Point](/api/oM/Dimensional/Geometry/Point)&gt; | Gets the two focal points of the Ellipse. For all points on the ellipse, the sum of the two distances to the focal points is constant. | - | Geometry_Engine |
...
| Normal | [Vector](/api/oM/Dimensional/Geometry/Vector) | Returns a vector normal to the plane of an ellipse. | - | Geometry_Engine |
| PointInRegion | [Point](/api/oM/Dimensional/Geometry/Point) | - | - | Geometry_Engine |
| StartDir | [Vector](/api/oM/Dimensional/Geometry/Vector) | Gets the tangent vector at the start of the Ellipse. An ellipse starts and ends at the first axis point, and move towards the second axis, hence second axis is the tangent at start and end. | - | Geometry_Engine |
