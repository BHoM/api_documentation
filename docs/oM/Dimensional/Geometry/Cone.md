...
|------------------|------------------|------------------|------------------|
| Centre | [Point](/om_documentation/oM/Dimensional/Geometry/Point) | Point defining the centre of the circular base | - |
| Axis | [Vector](/om_documentation/oM/Dimensional/Geometry/Vector) | Vector perperdicular to the Cone base. Defines the orientation in three-dimensional space | - |
| Radius | [double](https://learn.microsoft.com/en-us/dotnet/api/System.Double?view=netstandard-2.0) | Distance from the Centre to the edge of the circular base | [Length](/om_documentation/oM/Dimensional/Quantities/Attributes/Length) [m] |
| Height | [double](https://learn.microsoft.com/en-us/dotnet/api/System.Double?view=netstandard-2.0) | Distance from the centre of the base to the Cone's apex | [Length](/om_documentation/oM/Dimensional/Quantities/Attributes/Length) [m] |
