...
|------------------|------------------|------------------|------------------|
| Vertices | [List](https://learn.microsoft.com/en-us/dotnet/api/System.Collections.Generic.List-1?view=netstandard-2.0)&lt;[Point](/om_documentation/oM/Dimensional/Geometry/Point)&gt; | Defines the three-dimensional Mesh geometry as  X, Y, Z coordinates. | - |
| Faces | [List](https://learn.microsoft.com/en-us/dotnet/api/System.Collections.Generic.List-1?view=netstandard-2.0)&lt;[Face](/om_documentation/oM/Dimensional/Geometry/Face)&gt; | The list of polygons, defined as corner Point indices referencing the list of Vertices. | - |
...
| Bounds | [BoundingBox](/om_documentation/oM/Dimensional/Geometry/BoundingBox) | Returns the global world axis oriented enclosing BoundingBox for all verices of the mesh, i.e. the box with the smallest volume within which all the mesh vertices lie. | - | Geometry_Engine |
| Centres | [List](https://learn.microsoft.com/en-us/dotnet/api/System.Collections.Generic.List-1?view=netstandard-2.0)&lt;[Point](/om_documentation/oM/Dimensional/Geometry/Point)&gt; | - | - | Geometry_Engine |
...
| ExternalEdges | [List](https://learn.microsoft.com/en-us/dotnet/api/System.Collections.Generic.List-1?view=netstandard-2.0)&lt;[Line](/om_documentation/oM/Dimensional/Geometry/Line)&gt; | Gets the external edge curves of a mesh as a set of lines. Extraction is done by finding all unique edges in the mesh. | - | Geometry_Engine |
...
| Normals | [List](https://learn.microsoft.com/en-us/dotnet/api/System.Collections.Generic.List-1?view=netstandard-2.0)&lt;[Vector](/om_documentation/oM/Dimensional/Geometry/Vector)&gt; | Returns a list of vectors normal to each face of the mesh. | - | Geometry_Engine |
| SubParts | [List](https://learn.microsoft.com/en-us/dotnet/api/System.Collections.Generic.List-1?view=netstandard-2.0)&lt;[Mesh](/om_documentation/oM/Dimensional/Geometry/Mesh)&gt; | - | - | Geometry_Engine |
