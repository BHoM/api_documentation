...
|------------------|------------------|------------------|------------------|
| Curve3d | [ICurve](/api/oM/Dimensional/Geometry/ICurve) | Trim Curve in global X, Y, Z coordinates. | - |
| Curve2d | [ICurve](/api/oM/Dimensional/Geometry/ICurve) | Trim Curve in local surface U, V coordinates. | - |
