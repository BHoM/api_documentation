...
???+ bhom "The SurfaceTrim in inheriting from the following base type(s) and implements the following interfaces:"
...
|------------------|------------------|------------------|------------------|
| Curve3d | [ICurve](/api_documentation/oM/Dimensional/Geometry/ICurve) | Trim Curve in global X, Y, Z coordinates. | - |
| Curve2d | [ICurve](/api_documentation/oM/Dimensional/Geometry/ICurve) | Trim Curve in local surface U, V coordinates. | - |
