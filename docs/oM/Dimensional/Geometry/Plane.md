...
???+ bhom "The Plane in inheriting from the following base type(s) and implements the following interfaces:"
...
|------------------|------------------|------------------|------------------|
| Origin | [Point](/api_documentation/oM/Dimensional/Geometry/Point) | A point through which the plane passes | - |
| Normal | [Vector](/api_documentation/oM/Dimensional/Geometry/Vector) | Vector perpendicualar to the plane, defining the orientation in three-dimensional space | - |
...
|------------------|------------------|------------------|------------------|------------------|
| Bounds | [BoundingBox](/api_documentation/oM/Dimensional/Geometry/BoundingBox) | Returns the global world axis oriented BoundingBox of the Plane. If the Plane is parallel to any of the world axis, the returned BoundingBox will be an infinite flat box in the plane. If not, the rturned box will be infinite box in all coordinate directions. | - | Geometry_Engine |
