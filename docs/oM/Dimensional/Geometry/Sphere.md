...
|------------------|------------------|------------------|------------------|
| Centre | [Point](/api_documentation/oM/Dimensional/Geometry/Point) | Origin point defining location of the Sphere in three-dimensional space | - |
| Radius | [double](https://learn.microsoft.com/en-us/dotnet/api/System.Double?view=netstandard-2.0) | Distance from the Centre to the Sphere boundary surface | [Length](/api_documentation/oM/Dimensional/Quantities/Attributes/Length) [m] |
