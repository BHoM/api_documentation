...
???+ bhom "The Sphere in inheriting from the following base type(s) and implements the following interfaces:"
...
|------------------|------------------|------------------|------------------|
| Centre | [Point](/documentation/oM/Dimensional/Geometry/Point) | Origin point defining location of the Sphere in three-dimensional space | - |
| Radius | [double](https://learn.microsoft.com/en-us/dotnet/api/System.Double?view=netstandard-2.0) | Distance from the Centre to the Sphere boundary surface | [Length](/documentation/oM/Dimensional/Quantities/Attributes/Length) [m] |
