...
|------------------|------------------|------------------|------------------|
| Centreline | [ICurve](/api_documentation/oM/Dimensional/Geometry/ICurve) | Defines the central axis perpendicular to the circular cross sections, and thus the path along which the tubular surface follows. | - |
| Radius | [double](https://learn.microsoft.com/en-us/dotnet/api/System.Double?view=netstandard-2.0) | The distance from the Curve Centreline to a point on the Pipe surface. | [Length](/api_documentation/oM/Dimensional/Quantities/Attributes/Length) [m] |
...
| ExternalEdges | [List](https://learn.microsoft.com/en-us/dotnet/api/System.Collections.Generic.List-1?view=netstandard-2.0)&lt;[ICurve](/api_documentation/oM/Dimensional/Geometry/ICurve)&gt; | Gets the external edge curves of the Pipe. If the Pipe is capped, this returns a circle at each end of the centre curve. If the pipe is uncapped, this method returns an empty list. | - | Geometry_Engine |
