...
|------------------|------------------|------------------|------------------|
| Vertices | [IReadOnlyList](https://learn.microsoft.com/en-us/dotnet/api/System.Collections.Generic.IReadOnlyList-1?view=netstandard-2.0)&lt;[Point](/documentation/oM/Dimensional/Geometry/Point)&gt; | An ordered set of three-dimensional points defining the curve shape.<br>The list should not contain any duplicate points - the first point in the list will be treated as both the start and end point. | - |
...
| ControlPoints | [List](https://learn.microsoft.com/en-us/dotnet/api/System.Collections.Generic.List-1?view=netstandard-2.0)&lt;[Point](/documentation/oM/Dimensional/Geometry/Point)&gt; | Gets the controlpoints of the Polygon. These will be the Vertices of the Polygon, with the first point duplicated as the last control point. | - | Geometry_Engine |
...
| Vertices | [List](https://learn.microsoft.com/en-us/dotnet/api/System.Collections.Generic.List-1?view=netstandard-2.0)&lt;[Point](/documentation/oM/Dimensional/Geometry/Point)&gt; | Returns the Vertices of the Polygon. | - | Geometry_Engine |
