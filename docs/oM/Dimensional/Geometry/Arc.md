...
|------------------|------------------|------------------|------------------|
| CoordinateSystem | [Cartesian](/documentation/oM/Dimensional/Geometry/CoordinateSystem/Cartesian) | Defines Arc centre equal to Origin of the CoordinateSystem, as well as the orientation of the Arc in three-dimensional space, equal to local xy-Plane of the CoordinateSystem. | - |
| Radius | [double](https://learn.microsoft.com/en-us/dotnet/api/System.Double?view=netstandard-2.0) | Distance from the CoordinateSystem.Origin to the any point on Arc. | [Length](/documentation/oM/Dimensional/Quantities/Attributes/Length) [m] |
| StartAngle | [double](https://learn.microsoft.com/en-us/dotnet/api/System.Double?view=netstandard-2.0) | Angle in radians to the start point from the local x-axis, counter clockwise around the local z-axis. | [Angle](/documentation/oM/Dimensional/Quantities/Attributes/Angle) [rad] |
| EndAngle | [double](https://learn.microsoft.com/en-us/dotnet/api/System.Double?view=netstandard-2.0) | Angle in radians to the end point from the local x-axis, counter clockwise around the local z-axis. | [Angle](/documentation/oM/Dimensional/Quantities/Attributes/Angle) [rad] |
...
| Centre | [Point](/documentation/oM/Dimensional/Geometry/Point) | - | - | Geometry_Engine |
...
| ControlPoints | [List](https://learn.microsoft.com/en-us/dotnet/api/System.Collections.Generic.List-1?view=netstandard-2.0)&lt;[Point](/documentation/oM/Dimensional/Geometry/Point)&gt; | Gets points at start, quarter, mid thre quarters and end points on the Arc. | - | Geometry_Engine |
...
| DiscontinuityPoints | [List](https://learn.microsoft.com/en-us/dotnet/api/System.Collections.Generic.List-1?view=netstandard-2.0)&lt;[Point](/documentation/oM/Dimensional/Geometry/Point)&gt; | Gets the points at kinks of the curve. For an Arc this is the start and end points. | - | Geometry_Engine |
...
| EndDir | [Vector](/documentation/oM/Dimensional/Geometry/Vector) | Gets the tangent vector at the end of the Arc. | - | Geometry_Engine |
...
| IsValid | [bool](https://learn.microsoft.com/en-us/dotnet/api/System.Boolean?view=netstandard-2.0) | - | - | Geometry_Engine |
| Length | [double](https://learn.microsoft.com/en-us/dotnet/api/System.Double?view=netstandard-2.0) | Calculates the length of an Arc. | [Length](/documentation/oM/Dimensional/Quantities/Attributes/Length) [m] | Geometry_Engine |
...
| Normal | [Vector](/documentation/oM/Dimensional/Geometry/Vector) | Returns a vector normal to the plane of an arc. | - | Geometry_Engine |
| PointInRegion | [Point](/documentation/oM/Dimensional/Geometry/Point) | - | - | Geometry_Engine |
| StartDir | [Vector](/documentation/oM/Dimensional/Geometry/Vector) | Gets the tangent vector at the start of the Arc. | - | Geometry_Engine |
