...
| Centre | [Point](/api/oM/Dimensional/Geometry/Point) | - | - | Geometry_Engine |
...
| ControlPoints | [List](https://learn.microsoft.com/en-us/dotnet/api/System.Collections.Generic.List-1?view=netstandard-2.0)&lt;[Point](/api/oM/Dimensional/Geometry/Point)&gt; | Gets points at start, quarter, mid thre quarters and end points on the Arc. | - | Geometry_Engine |
...
| DiscontinuityPoints | [List](https://learn.microsoft.com/en-us/dotnet/api/System.Collections.Generic.List-1?view=netstandard-2.0)&lt;[Point](/api/oM/Dimensional/Geometry/Point)&gt; | Gets the points at kinks of the curve. For an Arc this is the start and end points. | - | Geometry_Engine |
...
| EndDir | [Vector](/api/oM/Dimensional/Geometry/Vector) | Gets the tangent vector at the end of the Arc. | - | Geometry_Engine |
...
| Normal | [Vector](/api/oM/Dimensional/Geometry/Vector) | Returns a vector normal to the plane of an arc. | - | Geometry_Engine |
| PointInRegion | [Point](/api/oM/Dimensional/Geometry/Point) | - | - | Geometry_Engine |
| StartDir | [Vector](/api/oM/Dimensional/Geometry/Vector) | Gets the tangent vector at the start of the Arc. | - | Geometry_Engine |
