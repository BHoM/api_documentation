...
|------------------|------------------|------------------|------------------|
| Centre | [Point](/documentation/oM/Dimensional/Geometry/Point) | Origin point defining location of the Circle in three-dimensional space. | - |
| Normal | [Vector](/documentation/oM/Dimensional/Geometry/Vector) | Vector perpendicular to the plane in which the Circle lies. | - |
| Radius | [double](https://learn.microsoft.com/en-us/dotnet/api/System.Double?view=netstandard-2.0) | Distance from the Centre to any point on Circle. | [Length](/documentation/oM/Dimensional/Quantities/Attributes/Length) [m] |
...
| Centroid | [Point](/documentation/oM/Dimensional/Geometry/Point) | Queries the centre of area for a Circle. | - | Geometry_Engine |
...
| ControlPoints | [List](https://learn.microsoft.com/en-us/dotnet/api/System.Collections.Generic.List-1?view=netstandard-2.0)&lt;[Point](/documentation/oM/Dimensional/Geometry/Point)&gt; | Gets points at start, quarter, mid thre quarters and end points on the Circle. | - | Geometry_Engine |
...
| EndDir | [Vector](/documentation/oM/Dimensional/Geometry/Vector) | Gets the tangent vector at the end of the Circle. | - | Geometry_Engine |
...
| Length | [double](https://learn.microsoft.com/en-us/dotnet/api/System.Double?view=netstandard-2.0) | Calculates the length of an Circle. | [Length](/documentation/oM/Dimensional/Quantities/Attributes/Length) [m] | Geometry_Engine |
| Normal | [Vector](/documentation/oM/Dimensional/Geometry/Vector) | Returns a vector normal to the plane of a circle. | - | Geometry_Engine |
| PointInRegion | [Point](/documentation/oM/Dimensional/Geometry/Point) | - | - | Geometry_Engine |
| StartDir | [Vector](/documentation/oM/Dimensional/Geometry/Vector) | Gets the tangent vector at the start of the Circle. | - | Geometry_Engine |
