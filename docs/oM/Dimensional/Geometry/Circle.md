...
???+ bhom "The Circle in inheriting from the following base type(s) and implements the following interfaces:"
...
|------------------|------------------|------------------|------------------|
| Centre | [Point](/api/oM/Dimensional/Geometry/Point) | Origin point defining location of the Circle in three-dimensional space. | - |
| Normal | [Vector](/api/oM/Dimensional/Geometry/Vector) | Vector perpendicular to the plane in which the Circle lies. | - |
...
| Centroid | [Point](/api/oM/Dimensional/Geometry/Point) | Queries the centre of area for a Circle. | - | Geometry_Engine |
...
| ControlPoints | [List](https://learn.microsoft.com/en-us/dotnet/api/System.Collections.Generic.List-1?view=netstandard-2.0)&lt;[Point](/api/oM/Dimensional/Geometry/Point)&gt; | Gets points at start, quarter, mid thre quarters and end points on the Circle. | - | Geometry_Engine |
...
| EndDir | [Vector](/api/oM/Dimensional/Geometry/Vector) | Gets the tangent vector at the end of the Circle. | - | Geometry_Engine |
...
| Normal | [Vector](/api/oM/Dimensional/Geometry/Vector) | Returns a vector normal to the plane of a circle. | - | Geometry_Engine |
| PointInRegion | [Point](/api/oM/Dimensional/Geometry/Point) | - | - | Geometry_Engine |
| StartDir | [Vector](/api/oM/Dimensional/Geometry/Vector) | Gets the tangent vector at the start of the Circle. | - | Geometry_Engine |
