...
|------------------|------------------|------------------|------------------|
| Min | [Point](/api/oM/Dimensional/Geometry/Point) | The lower bound values for the X, Y and Z coordinates of the Box corner Points. | - |
| Max | [Point](/api/oM/Dimensional/Geometry/Point) | The upper bound values for the X, Y and Z coordinates of the Box corner Points. | - |
...
|------------------|------------------|------------------|------------------|------------------|
| Bounds | [BoundingBox](/api/oM/Dimensional/Geometry/BoundingBox) | Returns the BoundingBox of the BoundingBox (itself). | - | Geometry_Engine |
...
| Extents | [Vector](/api/oM/Dimensional/Geometry/Vector) | - | - | Geometry_Engine |
