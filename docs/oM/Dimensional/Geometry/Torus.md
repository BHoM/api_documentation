...
|------------------|------------------|------------------|------------------|
| Centre | [Point](/api/oM/Dimensional/Geometry/Point) | Origin point defining location of the Torus in three-dimensional space. | - |
| Axis | [Vector](/api/oM/Dimensional/Geometry/Vector) | Vector defining the axis of revolution and the orientation of the Torus in three-dimensional space. | - |
