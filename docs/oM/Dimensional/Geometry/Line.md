...
???+ bhom "The Line in inheriting from the following base type(s) and implements the following interfaces:"
...
|------------------|------------------|------------------|------------------|
| Start | [Point](/api/oM/Dimensional/Geometry/Point) | - | - |
| End | [Point](/api/oM/Dimensional/Geometry/Point) | - | - |
...
| Centroid | [Point](/api/oM/Dimensional/Geometry/Point) | Queries the centre of area for a Line. | - | Geometry_Engine |
...
| ControlPoints | [List](https://learn.microsoft.com/en-us/dotnet/api/System.Collections.Generic.List-1?view=netstandard-2.0)&lt;[Point](/api/oM/Dimensional/Geometry/Point)&gt; | Gets the start and end points of the Line. | - | Geometry_Engine |
...
| Direction | [Vector](/api/oM/Dimensional/Geometry/Vector) | - | - | Geometry_Engine |
| DiscontinuityPoints | [List](https://learn.microsoft.com/en-us/dotnet/api/System.Collections.Generic.List-1?view=netstandard-2.0)&lt;[Point](/api/oM/Dimensional/Geometry/Point)&gt; | Gets the points at kinks of the curve. For an Line this is the start and end points. | - | Geometry_Engine |
...
| EndDir | [Vector](/api/oM/Dimensional/Geometry/Vector) | Gets the tangent vector at the end of the Line. | - | Geometry_Engine |
...
| StartDir | [Vector](/api/oM/Dimensional/Geometry/Vector) | Gets the tangent vector at the start of the Line. | - | Geometry_Engine |
