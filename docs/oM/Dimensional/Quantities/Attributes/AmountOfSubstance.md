...
# Quantities.Attributes.AmountOfSubstance
...
???+ bhom "The AmountOfSubstance in inheriting from the following base type(s) and implements the following interfaces:"
