...
# Quantities.Attributes.ElectricConductivity
...
???+ bhom "The ElectricConductivity in inheriting from the following base type(s) and implements the following interfaces:"
