...
# Spatial.ShapeProfiles.FabricatedISectionProfile
...
???+ bhom "The FabricatedISectionProfile in inheriting from the following base type(s) and implements the following interfaces:"
...
| TopFlangeWidth | [double](https://learn.microsoft.com/en-us/dotnet/api/System.Double?view=netstandard-2.0) | Full width of the top flange. | [Length](/api_documentation/oM/Dimensional/Quantities/Attributes/Length) [m] |
| BotFlangeWidth | [double](https://learn.microsoft.com/en-us/dotnet/api/System.Double?view=netstandard-2.0) | Full width of the bottom flange. | [Length](/api_documentation/oM/Dimensional/Quantities/Attributes/Length) [m] |
...
| WeldSize | [double](https://learn.microsoft.com/en-us/dotnet/api/System.Double?view=netstandard-2.0) | Fillet weld size between web and flanges. Measured as the distance between intersection of web and flange perpendicular to the edge of the weld. | [Length](/api_documentation/oM/Dimensional/Quantities/Attributes/Length) [m] |
