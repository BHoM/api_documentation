...
| TopFlangeWidth | [double](https://learn.microsoft.com/en-us/dotnet/api/System.Double?view=netstandard-2.0) | Full width of the top flange. | [Length](/om_documentation/oM/Dimensional/Quantities/Attributes/Length) [m] |
| BotFlangeWidth | [double](https://learn.microsoft.com/en-us/dotnet/api/System.Double?view=netstandard-2.0) | Full width of the bottom flange. | [Length](/om_documentation/oM/Dimensional/Quantities/Attributes/Length) [m] |
...
| WeldSize | [double](https://learn.microsoft.com/en-us/dotnet/api/System.Double?view=netstandard-2.0) | Fillet weld size between web and flanges. Measured as the distance between intersection of web and flange perpendicular to the edge of the weld. | [Length](/om_documentation/oM/Dimensional/Quantities/Attributes/Length) [m] |
