...
# Spatial.ShapeProfiles.RectangleProfile
...
???+ bhom "The RectangleProfile in inheriting from the following base type(s) and implements the following interfaces:"
...
| Height | [double](https://learn.microsoft.com/en-us/dotnet/api/System.Double?view=netstandard-2.0) | - | [Length](/api_documentation/oM/Dimensional/Quantities/Attributes/Length) [m] |
| Width | [double](https://learn.microsoft.com/en-us/dotnet/api/System.Double?view=netstandard-2.0) | - | [Length](/api_documentation/oM/Dimensional/Quantities/Attributes/Length) [m] |
| CornerRadius | [double](https://learn.microsoft.com/en-us/dotnet/api/System.Double?view=netstandard-2.0) | Fillet radius of all four corners of the rectangle. | [Length](/api_documentation/oM/Dimensional/Quantities/Attributes/Length) [m] |
