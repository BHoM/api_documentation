...
# Spatial.ShapeProfiles.ChannelProfile
...
???+ bhom "The ChannelProfile in inheriting from the following base type(s) and implements the following interfaces:"
...
| Height | [double](https://learn.microsoft.com/en-us/dotnet/api/System.Double?view=netstandard-2.0) | Full depth between the extreme fibres of the parallel flanges. | [Length](/api_documentation/oM/Dimensional/Quantities/Attributes/Length) [m] |
| FlangeWidth | [double](https://learn.microsoft.com/en-us/dotnet/api/System.Double?view=netstandard-2.0) | Full width between the extreme fibres of the web to the flange. | [Length](/api_documentation/oM/Dimensional/Quantities/Attributes/Length) [m] |
...
| FlangeThickness | [double](https://learn.microsoft.com/en-us/dotnet/api/System.Double?view=netstandard-2.0) | - | [Length](/api_documentation/oM/Dimensional/Quantities/Attributes/Length) [m] |
