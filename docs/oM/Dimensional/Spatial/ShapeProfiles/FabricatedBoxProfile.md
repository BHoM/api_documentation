...
# Spatial.ShapeProfiles.FabricatedBoxProfile
...
???+ bhom "The FabricatedBoxProfile in inheriting from the following base type(s) and implements the following interfaces:"
...
| WeldSize | [double](https://learn.microsoft.com/en-us/dotnet/api/System.Double?view=netstandard-2.0) | Fillet weld size between inside of webs and flanges. Measured as the distance between intersection of web and flange perpendicular to the edge of the weld. | [Length](/api_documentation/oM/Dimensional/Quantities/Attributes/Length) [m] |
