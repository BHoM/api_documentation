...
# Spatial.ShapeProfiles.TaperedProfile
...
???+ bhom "The TaperedProfile in inheriting from the following base type(s) and implements the following interfaces:"
...
| Profiles | [ReadOnlyDictionary](https://learn.microsoft.com/en-us/dotnet/api/System.Collections.ObjectModel.ReadOnlyDictionary-2?view=netstandard-2.0)&lt;[double](https://learn.microsoft.com/en-us/dotnet/api/System.Double?view=netstandard-2.0), [IProfile](/om_documentation/oM/Dimensional/Spatial/ShapeProfiles/IProfile)&gt; | - | - |
| Edges | [ReadOnlyCollection](https://learn.microsoft.com/en-us/dotnet/api/System.Collections.ObjectModel.ReadOnlyCollection-1?view=netstandard-2.0)&lt;[ICurve](/om_documentation/oM/Dimensional/Geometry/ICurve)&gt; | - | - |
