...
# Spatial.ShapeProfiles.FreeFormProfile
...
???+ bhom "The FreeFormProfile in inheriting from the following base type(s) and implements the following interfaces:"
