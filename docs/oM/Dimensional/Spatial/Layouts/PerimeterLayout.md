...
{
 "$ref" : "https://raw.githubusercontent.com/BHoM/BHoM_JSONSchema/develop/Spatial_oM/Layouts/PerimeterLayout.json"
}
```

The JSON Schema is available on github here:

- [PerimeterLayout.json](https://github.com/BHoM/BHoM_JSONSchema/blob/develop/Spatial_oM/Layouts/PerimeterLayout.json)
