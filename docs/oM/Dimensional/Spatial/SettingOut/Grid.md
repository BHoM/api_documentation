...
???+ bhom "The Grid in inheriting from the following base type(s) and implements the following interfaces:"
...
| Curve | [ICurve](/api/oM/Dimensional/Geometry/ICurve) | The centreline defining the Grid's path. Can be curved or linear. | - |
...
| Geometry | [ICurve](/api/oM/Dimensional/Geometry/ICurve) | Queries the defining Curve from the grid. | - | Spatial_Engine |
