...
| Curve | [ICurve](/api_documentation/oM/Dimensional/Geometry/ICurve) | The centreline defining the Grid's path. Can be curved or linear. | - |
...
| Geometry | [ICurve](/api_documentation/oM/Dimensional/Geometry/ICurve) | Queries the defining Curve from the grid. | - | Spatial_Engine |
